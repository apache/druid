...
/**
 * Wraps a {@link WritableFrameChannel} to track storage usage in {@link StorageCounters}.
 * Updates counters on each {@link #write} call: the first write increments the file count by one,
 * and every write increments bytes written.
 */
public class StorageCountingWritableFrameChannel implements WritableFrameChannel
{
  ...
  @Override
  public void write(final RowsAndColumns rac, final int partitionNum) throws IOException
  {
