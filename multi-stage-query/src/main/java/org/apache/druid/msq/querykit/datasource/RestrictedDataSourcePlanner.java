...
/**
 * Planner for {@link RestrictedDataSource}. Plans the base table, then reapplies the policy.
 */
public class RestrictedDataSourcePlanner implements DataSourcePlanner<RestrictedDataSource>
{
  @Override
