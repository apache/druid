...
/**
 * Worker-side extension point for {@link InputSlice}: provides an {@link InputSliceReader} for a particular
...
public interface InputSliceReaderProvider
{
   ...
   */
  InputSliceReader createReader(FrameContext frameContext, QueryContext queryContext);
}
