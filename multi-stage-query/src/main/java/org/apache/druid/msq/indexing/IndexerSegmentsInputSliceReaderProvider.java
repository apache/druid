 ...
 */
public class IndexerSegmentsInputSliceReaderProvider implements InputSliceReaderProvider
{
  @Override
  ...
  {
    return new SegmentsInputSliceReader(frameContext, MultiStageQueryContext.isReindex(queryContext));
  }
}
