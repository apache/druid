...
/**
 * Planner for {@link FilteredDataSource}. Plans the base datasource, then reapplies the filter.
 */
public class FilteredDataSourcePlanner implements DataSourcePlanner<FilteredDataSource>
{
  @Override
  ...
  )
  {
    ...
    final DataSource newDataSource = FilteredDataSource.create(basePlan.getNewDataSource(), dataSource.getFilter());
