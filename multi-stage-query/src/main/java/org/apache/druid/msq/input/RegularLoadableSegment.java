...
public class RegularLoadableSegment implements LoadableSegment
{
  ...
  public synchronized AcquireSegmentAction acquire()
  {
    ...
    if (cachedDataSegment != null) {
      final AcquireSegmentAction action = segmentManager.acquirePartialSegment(cachedDataSegment);
      ...
      return new AcquireSegmentAction(
          Suppliers.memoize(() -> FutureUtils.transformAsync(
              ...
              dataSegment -> LoadableSegmentUtils.countedLoad(
                  closer.register(segmentManager.acquirePartialSegment(dataSegment)).getSegmentFuture(),
                  dataSegment.getSize(),
                  inputCounters
              )
          )),
