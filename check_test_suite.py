...
always_run_jobs = ['license checks', 'license checks with Hadoop3', 'analyze dependencies', 'analyze hadoop 3 dependencies', '(openjdk8) packaging check', '(openjdk11) packaging check']
