...
import org.apache.druid.server.coordinator.balancer.DiskWeightedCostBalancerStrategyConfig;
    ...
    modules.add(
        new Module()
        {
          ...
          public void configure(Binder binder)
          {
            ...
            JsonConfigProvider.bind(binder, "druid.coordinator.balancer.diskWeighted", DiskWeightedCostBalancerStrategyConfig.class);
