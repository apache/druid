...
public class AsyncQueryForwardingServletTest extends BaseJettyTest
{
    ...
    public void testHandleExceptionWithFilterDisabled() throws Exception
    {
        ...
        ArgumentCaptor<Exception> captor=getArgumentCaptorofExceptionHandled(serverConfig,errorMessage,haveRequest);
    ...
    private ArgumentCaptor<Exception> getArgumentCaptorofExceptionHandled(ServerConfig serverConfig,String errorMessage,boolean haverequest) throws IOException {
