...
public class LoggingEmitterConfigTest
{
  ...
  {
    final Properties props = new Properties();
    props.setProperty("io.druid.java.util.emitter.loggerClass", "Foo");
    props.setProperty("io.druid.java.util.emitter.logLevel", "INFO");
  ...
  {
    final Properties props = new Properties();
    props.setProperty("io.druid.java.util.emitter.logging.class", "Foo");
    props.setProperty("io.druid.java.util.emitter.logging.level", "INFO");
