...
{
  @NotNull Response handlePOST(InputStream inputStream, ObjectMapper mapper);
  @NotNull Response handlePOSTAll(InputStream inputStream, ObjectMapper mapper);
  @NotNull Response handleGET(@NotNull String id);
  @NotNull Response handleGETAll();
  @NotNull Response handleDELETE(@NotNull String id);
