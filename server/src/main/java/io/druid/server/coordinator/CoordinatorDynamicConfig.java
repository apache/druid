  ...
  public static class Builder
  {
    ...
    public CoordinatorDynamicConfig build()
    {
      return new CoordinatorDynamicConfig(
          Objects.firstNonNull(millisToWaitBeforeDeleting, DEFAULT_MILLIS_TO_WAIT_BEFORE_DELETING),
          Objects.firstNonNull(mergeBytesLimit, DEFAULT_MERGE_BYTES_LIMIT),
          Objects.firstNonNull(mergeSegmentsLimit, DEFAULT_MERGE_SEGMENTS_LIMIT),
          Objects.firstNonNull(maxSegmentsToMove, DEFAULT_MAX_SEGMENTS_TO_MOVE),
          Objects.firstNonNull(replicantLifetime, DEFAULT_REPLICANT_LIFETIME),
          Objects.firstNonNull(replicationThrottleLimit, DEFAULT_REPLICATION_THROTTLE_LIMIT),
          Objects.firstNonNull(balancerComputeThreads, DEFAULT_BALANCER_COMPUTE_THREADS),
          Objects.firstNonNull(emitBalancingStats, DEFAULT_EMIT_BALANCING_STATS),
          killDataSourceWhitelist,
          Objects.firstNonNull(killAllDataSources, DEFAULT_KILL_ALL_DATA_SOURCES),
          Objects.firstNonNull(maxSegmentsInNodeLoadingQueue, DEFAULT_MAX_SEGMENTS_IN_NODE_LOADING_QUEUE)
      );
    }
