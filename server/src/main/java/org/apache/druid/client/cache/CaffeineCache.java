...
public class CaffeineCache implements org.apache.druid.client.cache.Cache
{
  ...
  public void doMonitor(ServiceEmitter emitter)
  {
    ...
    emitter.emit(builder.setMetricAndValue("query/cache/caffeine/delta/requests", deltaStats.requestCount()));
    emitter.emit(builder.setMetricAndValue("query/cache/caffeine/total/requests", newStats.requestCount()));
    emitter.emit(builder.setMetricAndValue("query/cache/caffeine/delta/loadTime", deltaStats.totalLoadTime()));
    emitter.emit(builder.setMetricAndValue("query/cache/caffeine/total/loadTime", newStats.totalLoadTime()));
    emitter.emit(builder.setMetricAndValue("query/cache/caffeine/delta/evictionBytes", deltaStats.evictionWeight()));
    emitter.emit(builder.setMetricAndValue("query/cache/caffeine/total/evictionBytes", newStats.evictionWeight()));
