...
{
  private static final Logger log = new Logger(ProcessingModuleHelper.class);

  public static String PROCESSING_PROPERTY_BASE = "druid.processing";

  public static void registerConfigsAndMonitor(Binder binder)
  {
    JsonConfigProvider.bind(binder, PROCESSING_PROPERTY_BASE, DruidProcessingConfig.class);
