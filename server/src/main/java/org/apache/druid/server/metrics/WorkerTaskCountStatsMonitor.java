...
public class WorkerTaskCountStatsMonitor extends AbstractMonitor
{
  ...
  public boolean doMonitor(ServiceEmitter emitter)
  {
    if (isMiddleManager) {
      ...
      emit(emitter, "indexer/task/failed/count", indexerStatsProvider.getWorkerFailedTasks());
      emit(emitter, "indexer/task/success/count", indexerStatsProvider.getWorkerSuccessfulTasks());
    }
    return true;
  }
