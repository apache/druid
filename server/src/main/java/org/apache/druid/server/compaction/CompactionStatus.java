...
public class CompactionStatus
{
  ...
  )
  {
    ...
    List<DimFilter> expectedFilters = ((OrDimFilter) expectedFilter.getField()).getFields();
  ...
  /**
   * Extracts applied filters from a CompactionState.
   * Returns null if transform spec or filter is null (indicating all filters should be applied).
   */
  @Nullable
