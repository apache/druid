...
public class CoordinatorDynamicConfig
{
  ...
  private final int maxSegmentsToConsiderPerMove;
  ...
  public CoordinatorDynamicConfig(
      ...
      @JsonProperty("maxSegmentsToConsiderPerMove") int maxSegmentsToConsiderPerMove,
  ...
  )
  {
    ...
    if (maxSegmentsToConsiderPerMove <= 0) {
      this.maxSegmentsToConsiderPerMove = Integer.MAX_VALUE;
    } else {
      this.maxSegmentsToConsiderPerMove = maxSegmentsToConsiderPerMove;
    }
  ...
  @JsonProperty
  public int getMaxSegmentsToConsiderPerMove()
  {
    return maxSegmentsToConsiderPerMove;
  }
  ...
  public String toString()
  {
    return "CoordinatorDynamicConfig{" +
           ...
           ", maxSegmentsToConsiderPerMove=" + maxSegmentsToConsiderPerMove +
  ...
  public boolean equals(Object o)
  {
    ...
    if (maxSegmentsToConsiderPerMove != that.maxSegmentsToConsiderPerMove) {
      return false;
    }
  ...
  public static class Builder
  {
    ...
    private static final int DEFAULT_MAX_SEGMENTS_TO_CONSIDER_PER_MOVE = Integer.MAX_VALUE;
    ...
    private Integer maxSegmentsToConsiderPerMove;
    ...
    public Builder(
        ...
        @JsonProperty("maxSegmentsToConsiderPerMove") @Nullable Integer maxSegmentsToConsiderPerMove,
    ...
    public Builder withMaxSegmentsToConsiderPerMove(int maxSegmentsToConsiderPerMove)
    {
      this.maxSegmentsToConsiderPerMove = maxSegmentsToConsiderPerMove;
      return this;
    }
    ...
    public CoordinatorDynamicConfig build()
    {
      return new CoordinatorDynamicConfig(
          ...
          maxSegmentsToConsiderPerMove == null ? DEFAULT_MAX_SEGMENTS_TO_CONSIDER_PER_MOVE : maxSegmentsToConsiderPerMove,
    ...
    public CoordinatorDynamicConfig build(CoordinatorDynamicConfig defaults)
    {
      return new CoordinatorDynamicConfig(
          ...
          maxSegmentsToConsiderPerMove == null ? defaults.getMaxSegmentsToConsiderPerMove() : maxSegmentsToConsiderPerMove,
