...
public class ClientQuerySegmentWalker implements QuerySegmentWalker
{
   ...
   * @param parentQueryId        Before inlining a subquery, it populates its id with the query id of the main query
   * @param parentSqlQueryId     Before inlining a subquery, it populates its sqlId with the sql id of the main query
   * @param subquerySequence     Denotes the subquery sequence number, for prepending to the subquery id
   */
