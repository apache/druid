...
public interface BalancerStrategy
{
   ...
   * @return {@link BalancerSegmentHolder} containing segment to move and server it current resides on, or null if there
   *         are no segments to pick from (i. e. all provided serverHolders are empty).
   */
  @Nullable
