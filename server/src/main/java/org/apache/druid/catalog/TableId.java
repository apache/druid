...
public class TableId
{
  ...
  // Extra for MSQE
  public static final String INPUT_SCHEMA = "input";
  ...
  public TableId(
      ...
      @JsonProperty("schema") String name)
  {
    this.schema = schema;
    this.name = name;
  }
  ...
  public static TableId inputSource(String name)
  {
    return new TableId(INPUT_SCHEMA, name);
  }
