...
public class ServiceClientImpl implements ServiceClient
{
   ...
   *
   * @param requestBuilder    request builder from call to {@link #asyncRequest(RequestBuilder, HttpResponseHandler)}
   * @param handler           handler from call to {@link #asyncRequest(RequestBuilder, HttpResponseHandler)}
   * @param retVal            return future generated by {@link #asyncRequest(RequestBuilder, HttpResponseHandler)}
