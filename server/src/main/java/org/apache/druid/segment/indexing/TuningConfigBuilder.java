 ...
 * @see TuningConfigBuilder#forClientCompactionTaskQuery()
 */
public abstract class TuningConfigBuilder<C>
{
  ...
  /**
   * Creates a new builder for {@link ClientCompactionTaskQueryTuningConfig}.
   */
  public static ClientCompactionTaskQuery forClientCompactionTaskQuery()
  {
    return new ClientCompactionTaskQuery();
  }

  /**
   * Creates a new builder for {@link UserCompactionTaskQueryTuningConfig}.
   */
  public static UserCompactionTaskQuery forUserCompactionTaskQuery()
  {
    return new UserCompactionTaskQuery();
  }

  public static class UserCompactionTaskQuery extends TuningConfigBuilder<UserCompactionTaskQueryTuningConfig>
  {
    @Override
  ...
  public static class ClientCompactionTaskQuery extends TuningConfigBuilder<ClientCompactionTaskQueryTuningConfig>
  {

    @Override
    public ClientCompactionTaskQueryTuningConfig build()
    {
