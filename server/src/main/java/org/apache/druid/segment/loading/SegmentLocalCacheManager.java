...
public class SegmentLocalCacheManager implements SegmentCacheManager
{
  ...
  ) throws SegmentLoadingException
  {
    ...
    final AcquireSegmentAction acquireExisting = acquireExistingSegment(
        dataSegment,
        descriptor,
        identifier
    );
    ...
    synchronized (lock) {
      try {
        final AcquireSegmentAction retryAcquireExisting = acquireExistingSegment(
            dataSegment,
            descriptor,
            identifier
        );
  ...
  private final class SegmentCacheEntry implements CacheEntry
  {
    ...
    @Override
    public synchronized void mount(final File location) throws SegmentLoadingException
    {
