...
public class CuratorServiceUtils
{
   ...
   *
   * <p>This method is marked protected because it should never be used outside of the
   * {@code org.apache.druid.curator.discovery} package. If you are tempted to use this method anywhere else you are
   * most likely doing something wrong. Mapping the actual service name to the name used within curator should be left
   * to {@link CuratorServiceAnnouncer}.
   *
