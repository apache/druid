...
app = angular.module('druid', ['ngRoute', 'ngClipboard', 'ngCsv', 'ui.bootstrap']);
...
app.factory('$druid', function($q, $http, $utils) {
  return {
    env: void 0,
    coordinator: void 0,
    proxy: function(path) {
...
app.factory('$utils', function() {
  return {
    ...
    resilience: function(tier) {
      return Math.floor(tier.nodes.length - tier.currSize / tier.nodes[0].maxSize);
    },
...
app.controller('DruidClusterCtrl', function($scope, $druid, $routeParams, $q) {
  $scope.env = $routeParams.env;
  if ($druid.env !== $scope.env) {
    $druid.env = $scope.env;
    $scope.coordinator = void 0;
    $druid.getCoordinator().then(function(c) {
      return $scope.coordinator = c;
    });
  } else {
    $scope.coordinator = $druid.coordinator;
  }
...
app.controller('DruidDataSourcesCtrl', function($scope, $druid, $routeParams, $q) {
  $scope.env = $routeParams.env;
  if ($druid.env !== $scope.env) {
    $druid.env = $scope.env;
    $scope.coordinator = void 0;
...
app.controller('DruidDataSourceCtrl', function($scope, $druid, $routeParams, $q) {
  $scope.env = $routeParams.env;
  if ($druid.env !== $scope.env) {
    $druid.env = $scope.env;
    $scope.coordinator = void 0;
