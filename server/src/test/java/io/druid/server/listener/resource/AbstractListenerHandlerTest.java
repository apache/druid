...
public class AbstractListenerHandlerTest
{
  ...
  final Collection<SomeBeanClass> all = ImmutableList.of();
  ...
  public void testSimple() throws Exception
  {
    ...
    final Response response = abstractListenerHandler.handlePOST(bais, mapper);
    Assert.assertEquals(202, response.getStatus());
    Assert.assertEquals(Collections.singletonList(val), response.getEntity());
  }
  ...
  {
    final Collection<SomeBeanClass> val = Collections.singletonList(new SomeBeanClass("a"));
  ...
  {
    final Collection<SomeBeanClass> val = ImmutableList.of();
    final ByteArrayInputStream bais = new ByteArrayInputStream(
        StringUtils.toUtf8(
            mapper.writeValueAsString(
                val
