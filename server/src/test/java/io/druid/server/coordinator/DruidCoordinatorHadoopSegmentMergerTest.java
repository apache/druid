  ...
  public void testMergeMixedShardSpecs()
  {
    ...
    final List<DataSegment> segments = ImmutableList.of(
        ...
        DataSegment.builder().dataSource("foo")
                   ...
                   .version("1")
                   .shardSpec(new HashBasedNumberedShardSpec(0, 2, null, mapper))
                   .size(25)
                   .build(),
        DataSegment.builder().dataSource("foo")
                   .interval(new Interval("2012-01-06/P1D"))
                   .version("1")
                   .shardSpec(new HashBasedNumberedShardSpec(1, 2, null, mapper))
                   .size(25)
                   .build(),
        DataSegment.builder().dataSource("foo")
  ...
  public void testMergeComplex()
  {
    ...
    final List<DataSegment> segments = ImmutableList.of(
        ...
        DataSegment.builder()
                   ...
                   .version("2")
                   .shardSpec(new HashBasedNumberedShardSpec(0, 3, null, mapper))
                   .size(50)
                   .build(),
        DataSegment.builder()
                   .dataSource("foo")
                   .interval(new Interval("2012-01-11/P1D"))
                   .version("2")
                   .shardSpec(new HashBasedNumberedShardSpec(1, 3, null, mapper))
                   .size(50)
                   .build(),
        DataSegment.builder()
                   .dataSource("foo")
                   .interval(new Interval("2012-01-11/P1D"))
                   .version("2")
                   .shardSpec(new HashBasedNumberedShardSpec(2, 3, null, mapper))
                   .size(50)
                   .build(),
        DataSegment.builder()
                   .dataSource("foo")
