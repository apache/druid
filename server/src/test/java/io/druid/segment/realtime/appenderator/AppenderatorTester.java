...
public class AppenderatorTester implements AutoCloseable
{
  ...
  )
  {
    ...
    schema = new DataSchema(
        ...
        new UniformGranularitySpec(Granularity.MINUTE, QueryGranularity.NONE, null),
        objectMapper
    );
    ...
    indexMaker = new IndexMaker(objectMapper, indexIO);
    ...
    appenderator = Appenderators.realtime(
        schema,
        tuningConfig,
        metrics,
        dataSegmentPusher,
