...
public class RoundRobinAssignmentTest extends CoordinatorSimulationBaseTest
{
  ...
  public void testMultipleDatasourceSegmentsAreAssignedUniformly()
  {
    ...
    runCoordinatorCycle();
    loadQueuedSegments();
    verifyValue(Metric.ASSIGNED_COUNT, filter(DruidMetrics.DATASOURCE, DS.KOALA), 10000L);
    verifyValue(Metric.ASSIGNED_COUNT, filter(DruidMetrics.DATASOURCE, DS.WIKI), 3000L);
