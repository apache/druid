...
public class ReservoirSegmentSamplerTest
{
  ...
  public void getRandomBalancerSegmentHolderTest()
  {
    ...
    EasyMock.expect(druidServer1.iterateAllSegments()).andReturn(segments1).anyTimes();
    ...
    EasyMock.expect(druidServer2.iterateAllSegments()).andReturn(segments2).anyTimes();
    ...
    EasyMock.expect(druidServer3.iterateAllSegments()).andReturn(segments3).anyTimes();
    ...
    EasyMock.expect(druidServer4.iterateAllSegments()).andReturn(segments4).anyTimes();
