...
public class MarkEternityTombstonesAsUnusedTest
{
  ...
  public void testCandidateTombstonesWithUsedOvershadowedSegments()
  {
    ...
    final SegmentTimeline timeline = segmentsMetadataManager.getDataSourceSnapshot()
  ...
  public void testCandidateTombstonesWithUsedOvershadowedSegments2()
  {
    ...
    final SegmentTimeline ds1Timeline = segmentsMetadataManager.getDataSourceSnapshot()
                                                               .getUsedSegmentsTimelinesPerDataSource()
                                                               .get(ds1);
  ...
  public void testCandidateTombstonesInMultipleDatasources()
  {
    ...
    SegmentTimeline ds1Timeline = segmentsMetadataManager.getDataSourceSnapshot()
                                                         .getUsedSegmentsTimelinesPerDataSource()
                                                         .get(ds1);
    ...
    SegmentTimeline ds2Timeline = segmentsMetadataManager.getDataSourceSnapshot()
                                                         .getUsedSegmentsTimelinesPerDataSource()
                                                         .get(ds2);
  ...
  public void testCandidateTombstonesWithPartiallyOverlappingSegment()
  {
    ...
    final SegmentTimeline ds2Timeline = segmentsMetadataManager.getDataSourceSnapshot()
                                                               .getUsedSegmentsTimelinesPerDataSource()
                                                               .get(ds2);
