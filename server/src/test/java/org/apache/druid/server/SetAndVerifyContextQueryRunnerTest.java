...
public class SetAndVerifyContextQueryRunnerTest
{
  ...
  public void testTimeoutIsUsedIfTimeoutIsNonZero() throws InterruptedException
  {
    ...
    Assert.assertTrue(
        System.currentTimeMillis() > transformed.getContextAsLong(DirectDruidClient.QUERY_FAIL_TIME)
    );
  }
  ...
  public void testTimeoutDefaultTooBigAndOverflows()
  {
    ...
    Assert.assertEquals((Long) Long.MAX_VALUE, transformed.getContextAsLong(DirectDruidClient.QUERY_FAIL_TIME));
  }
  ...
  public void testTimeoutZeroIsNotImmediateTimeoutExplicitServersideMax()
  {
    ...
    Assert.assertTrue(
        System.currentTimeMillis() < (Long) transformed.getContextAsLong(DirectDruidClient.QUERY_FAIL_TIME)
    );
  }
}
