...
public class LoadRuleTest
{
  ...
  /**
   * Tests segment load when a tier within load rule doesn't exists with servers to load to.
   *
   ...
   * REPPICA_ONLY - 1 replicant is loaded
   */
  @Test
  public void testLoadReplica()
  {
    ...
    ImmutableDruidServer server1 =
        new DruidServer("serverHot", "host1", null, 1000, ServerType.HISTORICAL, DruidServer.DEFAULT_TIER, 1).toImmutableDruidServer();
    ImmutableDruidServer server2 =
        new DruidServer("serverHot2", "host2", null, 1000, ServerType.HISTORICAL, DruidServer.DEFAULT_TIER, 1).toImmutableDruidServer();
    DruidCluster druidCluster = DruidClusterBuilder
        .newBuilder()
  ...
  public void testLoadPrimaryAndReplica()
  {
    ...
    ImmutableDruidServer server1 =
        new DruidServer("server1", "host1", null, 1000, ServerType.HISTORICAL, DruidServer.DEFAULT_TIER, 1).toImmutableDruidServer();
    ImmutableDruidServer server2 =
        new DruidServer("server2", "host2", null, 1000, ServerType.HISTORICAL, DruidServer.DEFAULT_TIER, 1).toImmutableDruidServer();
