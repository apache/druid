...
public class NewestSegmentFirstPolicyTest
{
  ...
  public void testIfSegmentsSkipOffsetWithConfiguredSegmentGranularityEqual()
  {
    ...
    final CompactionSegmentIterator iterator = policy.reset(
        ImmutableMap.of(DATA_SOURCE, createCompactionConfig(40000, new Period("P1D"), new CompactionGranularitySpec(Granularities.DAY, null))),
        ImmutableMap.of(DATA_SOURCE, timeline),
        Collections.emptyMap()
    );
  ...
  public void testIfSegmentsSkipOffsetWithConfiguredSegmentGranularityLarger()
  {
    ...
    final CompactionSegmentIterator iterator = policy.reset(
        ImmutableMap.of(DATA_SOURCE, createCompactionConfig(40000, new Period("P1D"), new CompactionGranularitySpec(Granularities.MONTH, null))),
        ImmutableMap.of(DATA_SOURCE, timeline),
        Collections.emptyMap()
    );
  ...
  public void testIfSegmentsSkipOffsetWithConfiguredSegmentGranularitySmaller()
  {
    ...
    final CompactionSegmentIterator iterator = policy.reset(
        ImmutableMap.of(DATA_SOURCE, createCompactionConfig(40000, new Period("P1D"), new CompactionGranularitySpec(Granularities.MINUTE, null))),
        ImmutableMap.of(DATA_SOURCE, timeline),
        Collections.emptyMap()
    );
  ...
  public void testIteratorReturnsSegmentsInConfiguredSegmentGranularity()
  {
    ...
    final CompactionSegmentIterator iterator = policy.reset(
        ImmutableMap.of(DATA_SOURCE, createCompactionConfig(130000, new Period("P0D"), new CompactionGranularitySpec(Granularities.MONTH, null))),
        ImmutableMap.of(DATA_SOURCE, timeline),
        Collections.emptyMap()
    );
  ...
  public void testIteratorDoesNotReturnCompactedInterval()
  {
    ...
    final CompactionSegmentIterator iterator = policy.reset(
        ImmutableMap.of(DATA_SOURCE, createCompactionConfig(40000, new Period("P0D"), new CompactionGranularitySpec(Granularities.MINUTE, null))),
        ImmutableMap.of(DATA_SOURCE, timeline),
        Collections.emptyMap()
    );
