...
public class CompactionEligibilityEvaluateTest
{
  ...
  public void testFindPartitionsSpecWhenGivenIsNull()
  {
    ...
    Assert.assertNull(CompactionEligibility.findPartitionsSpecFromConfig(tuningConfig));
  }
  ...
  public void testFindPartitionsSpecWhenGivenIsDynamicWithNullMaxTotalRows()
  {
    ...
    Assert.assertEquals(
        ...
        CompactionEligibility.findPartitionsSpecFromConfig(tuningConfig)
    );
  }
  ...
  public void testFindPartitionsSpecFromConfigWithDeprecatedMaxRowsPerSegmentAndMaxTotalRowsReturnGivenValues()
  {
    ...
    Assert.assertEquals(
        ...
        CompactionEligibility.findPartitionsSpecFromConfig(ClientCompactionTaskQueryTuningConfig.from(config))
    );
  }
  ...
  public void testStatusWhenLastCompactionStateSameAsRequired()
  {
    ...
    final CompactionEligibility status = CompactionEligibility.evaluate(
        CompactionCandidate.ProposedCompaction.from(List.of(segment), Granularities.HOUR),
        compactionConfig,
        new NewestSegmentFirstPolicy(null),
        fingerprintMapper
    );
    Assert.assertEquals(CompactionEligibility.State.NOT_APPLICABLE, status.getState());
  }
  ...
  public void testStatusWhenProjectionsMatch()
  {
    ...
    Assert.assertEquals(CompactionEligibility.NOT_APPLICABLE, status);
  }
  ...
  public void testStatusWhenProjectionsMismatch()
  {
    ...
    Assert.assertEquals(CompactionEligibility.State.FULL_COMPACTION, status.getState());
  ...
  public void test_evaluate_isSkippedWhenInputBytesExceedLimit()
  {
    ...
    Assert.assertFalse(status.getState().equals(CompactionEligibility.State.FULL_COMPACTION));
