...
public class IntervalsByGranularityTest
{
  ...
  {
    Interval first = new Interval("2013-01-01T00Z/2013-02-01T00Z");
    Interval second = new Interval("2012-01-01T00Z/2012-02-01T00Z");
    Interval third = new Interval("2002-01-01T00Z/2003-01-01T00Z");
  ...
  {
    Interval first = new Interval("2013-01-01T00Z/2013-02-01T00Z");
    Interval second = new Interval("2012-04-01T00Z/2012-05-01T00Z");
    Interval third = new Interval("2013-01-01T00Z/2013-02-01T00Z"); // dup
  ...
  {
    Interval first = new Interval("2012-01-01T00Z/2012-12-31T00Z");
    Interval second = new Interval("2002-01-01T00Z/2002-12-31T00Z");
    Interval third = new Interval("2021-01-01T00Z/2021-06-30T00Z");
    IntervalsByGranularity intervals = new IntervalsByGranularity(
        ImmutableList.of(first, second, third),
