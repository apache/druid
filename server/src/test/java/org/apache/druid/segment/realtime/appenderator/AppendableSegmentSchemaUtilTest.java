...
public class AppendableSegmentSchemaUtilTest
{
  @Test
  public void testComputeAbsoluteSchemaEmpty()
  {
    Assert.assertEquals(Optional.empty(), AppendableSegmentSchemaUtil.computeAbsoluteSchema(new HashMap<>()));
  }

  @Test
  public void testComputeAbsoluteSchema()
  {
    Map<SegmentId, Pair<RowSignature, Integer>> appendableSegmentSchemaMap = new HashMap<>();
    ...
    appendableSegmentSchemaMap.put(segment1, schema1);
    ...
    Optional<SegmentSchemas> segmentSchemas = AppendableSegmentSchemaUtil.computeAbsoluteSchema(appendableSegmentSchemaMap);
  ...
  {
    Map<SegmentId, Pair<RowSignature, Integer>> previousAppendableSegmentSchemaMap = new HashMap<>();
    ...
    columnTypeMap1.put("dim3", ColumnType.NESTED_DATA);
    Pair<RowSignature, Integer> schema1 = Pair.of(toRowSignature(columnTypeMap1), 20);
    previousAppendableSegmentSchemaMap.put(segment1, schema1);
    ...
    columnTypeMap2.put("dim4", ColumnType.NESTED_DATA);
    Pair<RowSignature, Integer> schema2 = Pair.of(toRowSignature(columnTypeMap2), 40);
    previousAppendableSegmentSchemaMap.put(segment2, schema2);
    ...
    previousAppendableSegmentSchemaMap.put(segment3, schema3);

    Assert.assertFalse(AppendableSegmentSchemaUtil.computeSchemaChange(previousAppendableSegmentSchemaMap, previousAppendableSegmentSchemaMap).isPresent());
  }
  ...
  public void testComputeSchemaChange()
  {
    ...
    Map<SegmentId, Pair<RowSignature, Integer>> currentAppendableSegmentSchemaMap = new HashMap<>();
    ...
    currentAppendableSegmentSchemaMap.put(segment1, currSchema1);

    // no change for segment2
    currentAppendableSegmentSchemaMap.put(segment2, schema2);

    // numRows changes for segment3
    Pair<RowSignature, Integer> currSchema3 = Pair.of(toRowSignature(columnTypeMap3), 100);
    currentAppendableSegmentSchemaMap.put(segment3, currSchema3);
    ...
    currentAppendableSegmentSchemaMap.put(segment4, schema4);

    Optional<SegmentSchemas> segmentSchemasChange = AppendableSegmentSchemaUtil.computeSchemaChange(previousAppendableSegmentSchemaMap, currentAppendableSegmentSchemaMap);
