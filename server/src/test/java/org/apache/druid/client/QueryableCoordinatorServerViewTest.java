...
public class QueryableCoordinatorServerViewTest extends CuratorTestBase
{
  ...
  private QueryableCoordinatorServerView overlordServerView;

  public QueryableCoordinatorServerViewTest()
  {
  ...
  private void setupViews() throws Exception
  {
    ...
    overlordServerView = new QueryableCoordinatorServerView(
