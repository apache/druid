...
public class DirectDruidClientTest
{
  ...
  public void testRun() throws Exception
  {
    ...
    Sequence s1 = client1.run(QueryPlus.wrap(query), ResponseContext.createEmpty());
    ...
    client1.run(QueryPlus.wrap(query), ResponseContext.createEmpty());
    ...
    client2.run(QueryPlus.wrap(query), ResponseContext.createEmpty());
    client2.run(QueryPlus.wrap(query), ResponseContext.createEmpty());
  ...
  public void testCancel()
  {
    ...
    Sequence results = client1.run(QueryPlus.wrap(query), ResponseContext.createEmpty());
