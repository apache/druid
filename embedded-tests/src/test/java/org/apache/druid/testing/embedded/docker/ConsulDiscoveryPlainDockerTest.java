...
/**
 * Tests Consul service discovery and leader election with plain HTTP (no encryption).
 * Inherits all common tests from {@link BaseConsulDiscoveryDockerTest}.
 */
public class ConsulDiscoveryPlainDockerTest extends BaseConsulDiscoveryDockerTest
{
  @Override
  protected ConsulSecurityMode getConsulSecurityMode()
  {
    return ConsulSecurityMode.PLAIN;
  }
}
