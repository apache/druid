...
public abstract class CompactionSupervisorTestBase extends EmbeddedClusterTestBase
{
  ...
  protected UserCompactionTaskQueryTuningConfig createTuningConfigWithPartitionsSpec(PartitionsSpec partitionsSpec)
  {
  ...
  protected void verifyCompactedSegmentsHaveFingerprints(DataSourceCompactionConfig compactionConfig)
  {
