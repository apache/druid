...
public class ParserTest extends InitializedNullHandlingTest
{
  ...
  )
  {
    ...
    final Expr.ExprInputBindingAnalysis deets = parsed.analyzeInputs();
    ...
    final Expr.ExprInputBindingAnalysis roundTripDeets = roundTrip.analyzeInputs();
  ...
  {
    final Expr parsed = Parser.parse(expression, ExprMacroTable.nil());
    Expr.ExprInputBindingAnalysis deets = parsed.analyzeInputs();
    ...
    Expr.ExprInputBindingAnalysis roundTripDeets = parsedRoundTrip.analyzeInputs();
