...
public class HumanReadableBytesTest
{
  ...
  @Test
  public void testFormatInDecimalNoSpace()
  {
    Assert.assertEquals("1.00", HumanReadableBytes.format(1, 2, HumanReadableBytes.UnitSystem.DECIMAL, false));
    Assert.assertEquals("1.00K", HumanReadableBytes.format(1000L, 2, HumanReadableBytes.UnitSystem.DECIMAL, false));
    Assert.assertEquals("1.00M", HumanReadableBytes.format(1000L * 1000, 2, HumanReadableBytes.UnitSystem.DECIMAL, false));
    Assert.assertEquals("1.00G", HumanReadableBytes.format(1000L * 1000 * 1000, 2, HumanReadableBytes.UnitSystem.DECIMAL, false));
    Assert.assertEquals("1.00T", HumanReadableBytes.format(1000L * 1000 * 1000 * 1000, 2, HumanReadableBytes.UnitSystem.DECIMAL, false));
    Assert.assertEquals("1.00P", HumanReadableBytes.format(1000L * 1000 * 1000 * 1000 * 1000, 2, HumanReadableBytes.UnitSystem.DECIMAL, false));
    Assert.assertEquals("9.22E", HumanReadableBytes.format(Long.MAX_VALUE, 2, HumanReadableBytes.UnitSystem.DECIMAL, false));

    Assert.assertEquals("1P", HumanReadableBytes.format(1000L * 1000 * 1000 * 1000 * 1000, 0, HumanReadableBytes.UnitSystem.DECIMAL, false));
    Assert.assertEquals("9E", HumanReadableBytes.format(Long.MAX_VALUE, 0, HumanReadableBytes.UnitSystem.DECIMAL, false));
  }
  ...
  public void testInvalidPrecisionArgumentLowerBound()
  {
    ...
    Assert.assertEquals("1.00", HumanReadableBytes.format(1, -1, HumanReadableBytes.UnitSystem.DECIMAL, false));
  }
  ...
  public void testInvalidPrecisionArgumentUpperBound()
  {
    ...
    Assert.assertEquals("1.000", HumanReadableBytes.format(1, 3, HumanReadableBytes.UnitSystem.DECIMAL, false));
    Assert.assertEquals("1.00", HumanReadableBytes.format(1, 4, HumanReadableBytes.UnitSystem.DECIMAL, false));
  }
