...
public abstract class DoublesBivariateFunctionVectorProcessor extends BivariateFunctionVectorProcessor<double[], double[], double[]>
{
  public DoublesBivariateFunctionVectorProcessor(
