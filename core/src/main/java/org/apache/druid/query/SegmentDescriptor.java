 ...
 * is determined by the context (e. g. in {@link org.apache.druid.client.CachingClusteredClient}, where
 * SegmentDescriptor is used when Brokers tell data servers which segments to include for a particular query) and where
 * having lean JSON representations is important, because it's actively transferred detween Druid nodes. It's also for
 * this reason that the JSON field names of SegmentDescriptor are abbreviated.
 */
