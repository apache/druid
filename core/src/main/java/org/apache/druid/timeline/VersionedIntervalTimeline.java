...
public class VersionedIntervalTimeline<VersionType, ObjectType extends Overshadowable<ObjectType>> implements TimelineLookup<VersionType, ObjectType>
{
  ...
  /**
   * Returns a lazy collection with all objects (including partially overshadowed, but not fully overshadowed, see
   * {@link #findFullyOvershadowed}) in this VersionedIntervalTimeline to be used for iteration or {@link
