...
public class S3TaskLogsTest extends EasyMockSupport
{
  ...
  public void test_pushTaskPayload() throws IOException
  {
    ...
    s3Client.upload(EasyMock.capture(putObjectRequestCapture), EasyMock.capture(fileCapture));
  ...
  public void test_streamTaskPayload() throws IOException
  {
    ...
    byte[] taskPayloadBytes = taskPayloadString.getBytes(Charset.defaultCharset());
    ResponseInputStream<GetObjectResponse> s3Object = new ResponseInputStream<>(
        GetObjectResponse.builder().contentLength((long) taskPayloadBytes.length).build(),
        AbortableInputStream.create(new ByteArrayInputStream(taskPayloadBytes))
    );
  ...
  public void test_taskLog_fetch() throws IOException
  {
    ...
    byte[] content = LOG_CONTENTS.getBytes(StandardCharsets.UTF_8);
    ...
    EasyMock.expect(s3Client.getObject(EasyMock.anyObject(GetObjectRequest.class))).andReturn(responseStream);
    EasyMock.replay(s3Client);
  ...
  public void test_taskLog_fetch_withRange() throws IOException
  {
    ...
    byte[] content = LOG_CONTENTS.substring(1).getBytes(StandardCharsets.UTF_8);
    ResponseInputStream<GetObjectResponse> responseStream = new ResponseInputStream<>(
        GetObjectResponse.builder().contentLength((long) content.length).build(),
        AbortableInputStream.create(new ByteArrayInputStream(content))
    );
  ...
  public void test_report_fetch() throws IOException
  {
    ...
    byte[] content = REPORT_CONTENTS.getBytes(StandardCharsets.UTF_8);
    ResponseInputStream<GetObjectResponse> responseStream = new ResponseInputStream<>(
        GetObjectResponse.builder().contentLength((long) content.length).build(),
        AbortableInputStream.create(new ByteArrayInputStream(content))
    );
  ...
  public void test_status_fetch() throws IOException
  {
    ...
    byte[] content = STATUS_CONTENTS.getBytes(StandardCharsets.UTF_8);
    ResponseInputStream<GetObjectResponse> responseStream = new ResponseInputStream<>(
        GetObjectResponse.builder().contentLength((long) content.length).build(),
        AbortableInputStream.create(new ByteArrayInputStream(content))
    );
