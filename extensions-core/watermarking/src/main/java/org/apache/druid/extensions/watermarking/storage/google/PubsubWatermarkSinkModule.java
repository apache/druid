...
public class PubsubWatermarkSinkModule extends WatermarkSinkModule implements DruidModule
{
  public static final String TYPE = "pubsub";

  public PubsubWatermarkSinkModule()
  {
    super(TYPE);
  }
  ...
  public void configure(Binder binder)
  {
    ...
    JsonConfigProvider.bind(
        ...
        PubsubWatermarkSinkConfig.class
    );

    PolyBind.optionBinder(binder, Key.get(WatermarkSink.class))
            .addBinding(TYPE)
            .to(PubsubWatermarkSink.class)
