...
public class BatchGapDetectorFactory implements GapDetectorFactory
{
  @Override
  public String getGapType()
  {
    return BatchGapDetector.GAP_TYPE;
  }

  @Override
  public BatchGapDetector build(
      String dataSource,
      Interval interval,
  ...
  )
  {
    if (segments.size() > 1) {
      ...
      return new BatchGapDetector(dataSource, timelineInterval);
    }
    return null;
  }
}
