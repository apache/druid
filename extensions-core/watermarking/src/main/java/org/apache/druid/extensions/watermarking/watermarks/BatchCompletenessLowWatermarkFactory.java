...
public class BatchCompletenessLowWatermarkFactory extends WatermarkCursorFactory
{
  @Inject
  public BatchCompletenessLowWatermarkFactory(
      WatermarkCache cache,
      WatermarkSink watermarkSink
  )
  {
    super(cache, watermarkSink);
  }

  @Override
  public String getGapType()
  {
    return BatchCompletenessLowWatermark.TYPE;
  }
  ...
  {
    BatchCompletenessLowWatermark watermark = new BatchCompletenessLowWatermark(
        cache,
        watermarkSink,
        dataSource,
        interval
  ...
  {
    BatchCompletenessLowWatermark wm =
        new BatchCompletenessLowWatermark(cache, watermarkSink, dataSource, null);
  ...
  {
    return new BatchCompletenessLowWatermark(cache, watermarkSink, dataSource, null);
  }
}
