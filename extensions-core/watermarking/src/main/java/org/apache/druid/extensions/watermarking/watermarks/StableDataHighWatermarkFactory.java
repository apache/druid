...
public class StableDataHighWatermarkFactory extends WatermarkCursorFactory
{
  @Inject
  public StableDataHighWatermarkFactory(
  ...
  {
    return StableDataHighWatermark.TYPE;
  }
  ...
  {
    return new StableDataHighWatermark(cache, watermarkSink, dataSource, interval);
  }
  ...
  {
    throw new UOE("%s cannot be manually overridden", StableDataHighWatermark.TYPE);
  }

  @Override
  public Watermark getWatermark(String dataSource)
  {
    return new StableDataHighWatermark(cache, watermarkSink, dataSource, null);
  }
}
