...
public class KafkaIndexTaskClientTest extends EasyMockSupport
{
  ...
  public void testGetStatus() throws Exception
  {
    ...
    Capture<Request> captured = Capture.newInstance();
    expect(responseHolder.getStatus()).andReturn(HttpResponseStatus.OK);
    expect(responseHolder.getContent()).andReturn(StringUtils.safeFormat("\"%s\"", status.toString())).anyTimes();
    expect(httpClient.go(capture(captured), anyObject(FullResponseHandler.class), eq(TEST_HTTP_TIMEOUT))).andReturn(
        Futures.immediateFuture(responseHolder)
    );
    replayAll();
  ...
  public void testStopAsync() throws Exception
  {
    ...
    for (int i = 0; i < numRequests; i++) {
      expectedUrls.add(new URL(StringUtils.safeFormat(URL_FORMATTER, TEST_HOST, TEST_PORT, TEST_IDS.get(i), "stop")));
  ...
  public void testResumeAsync() throws Exception
  {
    ...
    List<ListenableFuture<Boolean>> futures = Lists.newArrayList();
    for (int i = 0; i < numRequests; i++) {
      expectedUrls.add(new URL(StringUtils.safeFormat(URL_FORMATTER, TEST_HOST, TEST_PORT, TEST_IDS.get(i), "resume")));
  ...
  public void testPauseAsync() throws Exception
  {
    ...
    for (int i = 0; i < numRequests; i++) {
      expectedUrls.add(new URL(StringUtils.safeFormat(URL_FORMATTER, TEST_HOST, TEST_PORT, TEST_IDS.get(i), "pause")));
  ...
  public void testPauseAsyncWithTimeout() throws Exception
  {
    ...
    List<ListenableFuture<Map<Integer, Long>>> futures = Lists.newArrayList();
    for (int i = 0; i < numRequests; i++) {
      expectedUrls.add(new URL(StringUtils.safeFormat(URL_FORMATTER, TEST_HOST, TEST_PORT, TEST_IDS.get(i), "pause?timeout=9")));
  ...
  public void testGetStatusAsync() throws Exception
  {
    ...
    for (int i = 0; i < numRequests; i++) {
      expectedUrls.add(new URL(StringUtils.safeFormat(URL_FORMATTER, TEST_HOST, TEST_PORT, TEST_IDS.get(i), "status")));
  ...
  public void testGetStartTimeAsync() throws Exception
  {
    ...
    for (int i = 0; i < numRequests; i++) {
      expectedUrls.add(new URL(StringUtils.safeFormat(URL_FORMATTER, TEST_HOST, TEST_PORT, TEST_IDS.get(i), "time/start")));
  ...
  public void testGetCurrentOffsetsAsync() throws Exception
  {
    ...
    List<ListenableFuture<Map<Integer, Long>>> futures = Lists.newArrayList();
    for (int i = 0; i < numRequests; i++) {
      expectedUrls.add(new URL(StringUtils.safeFormat(URL_FORMATTER, TEST_HOST, TEST_PORT, TEST_IDS.get(i), "offsets/current")));
  ...
  public void testGetEndOffsetsAsync() throws Exception
  {
    ...
    List<ListenableFuture<Map<Integer, Long>>> futures = Lists.newArrayList();
    for (int i = 0; i < numRequests; i++) {
      expectedUrls.add(new URL(StringUtils.safeFormat(URL_FORMATTER, TEST_HOST, TEST_PORT, TEST_IDS.get(i), "offsets/end")));
