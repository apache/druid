...
public class KafkaIndexTaskTuningConfig extends SeekableStreamIndexTaskTuningConfig
{
  public KafkaIndexTaskTuningConfig(
      ...
      @Nullable Boolean messageGapStatsEnabled
  )
  {
    super(
        appendableIndexSpec,
  ...
  private KafkaIndexTaskTuningConfig(
      ...
      @JsonProperty("messageGapStatsEnabled") @Nullable Boolean messageGapStatsEnabled
  )
  {
    this(
        appendableIndexSpec,
  ...
  public String toString()
  {
    return "KafkaIndexTaskTuningConfig{" +
           ...
           ", messageGapStatsEnabled=" + getMessageGapStatsEnabled() +
           '}';
  }
