...
/**
 * Represents a realtime segment, that must be queried at a task pointed to by {@link DruidServerMetadata}.
 */
public class DartQueryableRealtimeTask extends DartQueryableSegment
{
  private final DruidServerMetadata realtimeServer;

  public DartQueryableRealtimeTask(
      DataSegment segment,
      Interval interval,
      DruidServerMetadata realtimeServer
  )
  {
    super(segment, interval, -1);
