...
public class ControllerImpl implements Controller
{
  ...
  ) throws IOException
  {
    ...
    if (MSQControllerTask.isIngestion(querySpec)) {
      ...
      ExportMetadataManager exportMetadataManager = new ExportMetadataManager(destination.getExportStorageProvider(), context.tempDir());
  ...
  )
  {
    ...
    if (MSQControllerTask.isIngestion(querySpec)) {
      ...
      try {
        ...
        Iterator<String> filesIterator = exportStorageProvider.createStorageConnector(context.tempDir()).listDir("");
