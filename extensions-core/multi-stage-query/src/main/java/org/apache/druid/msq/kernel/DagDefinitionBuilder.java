 ...
 */
public class DagDefinitionBuilder
{
   ...
   */
  DagDefinitionBuilder(final String queryId)
  {
    this.queryId = queryId;
  }

  public DagDefinitionBuilder add(final StageDefinitionBuilder stageBuilder)
  {
    stageBuilders.add(stageBuilder);
    return this;
  }

  public DagDefinitionBuilder addAll(final QueryDefinition queryDef)
  {
  ...
  public DagDefinitionBuilder addAll(final DagDefinitionBuilder queryDefBuilder)
  {
