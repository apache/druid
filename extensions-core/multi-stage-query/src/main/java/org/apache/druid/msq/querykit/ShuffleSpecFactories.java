...
public class ShuffleSpecFactories
{
  ...
  public static ShuffleSpecFactory hashLocalSortWithMaxPartitionCount(final int partitions)
  {
    return (clusterBy, aggregate) -> new HashShuffleSpec(clusterBy, partitions, aggregate);
  }
