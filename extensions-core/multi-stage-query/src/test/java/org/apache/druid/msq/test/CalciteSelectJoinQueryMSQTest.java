  ...
  public abstract static class Base extends CalciteJoinQueryTest
  {
    ...
    protected QueryTestBuilder testBuilder()
    {
            Map<String, Object> defaultCtx = ImmutableMap.<String, Object>builder()
                    ...
                    .put(PlannerContext.CTX_SQL_JOIN_ALGORITHM, joinAlgorithm1().toString())
                    .build();


//      isSortBasedJoin()
      return
//          new QueryTestBuilder(new CalciteTestConfig(defaultCtx, true))
          new QueryTestBuilder(new CalciteTestConfig(true))
          .addCustomRunner(
    ...
    private JoinAlgorithm joinAlgorithm1()
    {
      return isSortBasedJoin() ? JoinAlgorithm.SORT_MERGE : JoinAlgorithm.BROADCAST;
