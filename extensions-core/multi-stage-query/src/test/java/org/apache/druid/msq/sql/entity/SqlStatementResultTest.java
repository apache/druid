...
public class SqlStatementResultTest
{
  ...
  public static final String JSON_STRING = "{\"queryId\":\"q1\","
                                           ...
                                           + "\"durationMs\":100,"
                                           + "\"result\":{\"resultFormat\":\"object\",\"dataSource\":\"ds\",\"sampleRecords\":[[\"1\"],[\"2\"],[\"3\"]],\"pageInformationList\":[{\"numRows\":1,\"sizeInBytes\":1,\"id\":0}]},"
  ...
  public void sanityTest() throws JsonProcessingException
  {
    ...
    Assert.assertEquals(
        ...
        + " durationInMs=100,"
        + " resultSetInformation=ResultSetInformation{resultFormat=object, records=[[1], [2], [3]], dataSource='ds', pageInformationList=[PageInformation{numRows=1, sizeInBytes=1, id=0}]},"
