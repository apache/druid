...
public class ResultSetInformationTest
{
  ...
  public void sanityTest() throws JsonProcessingException
  {
    ...
    Assert.assertEquals(
        "ResultSetInformation{numTotalRows=1, totalSizeInBytes=1, resultFormat=object, records=null, dataSource='ds', pages=[PageInformation{id=0, numRows=1, sizeInBytes=1}]}",
        RESULTS.toString()
    );
  }
