  ...
  public void testQuantileOnComplexColumn() throws Exception
  {
    ...
    try {
      ...
      Query expected = Druids.newTimeseriesQueryBuilder()
                             ...
                             .aggregators(ImmutableList.of(
                                 new FixedBucketsHistogramAggregatorFactory(
                                     "a0:agg", "fbhist_m1", 20, 0.0, 10.0, FixedBucketsHistogram.OutlierHandlingMode.IGNORE
                                 ),
                                 new FixedBucketsHistogramAggregatorFactory(
                                     "a2:agg", "fbhist_m1", 30, 0.0, 10.0, FixedBucketsHistogram.OutlierHandlingMode.IGNORE
                                 ),
                                 new FilteredAggregatorFactory(
                                     new FixedBucketsHistogramAggregatorFactory(
                                         "a4:agg", "fbhist_m1", 20, 0.0, 10.0, FixedBucketsHistogram.OutlierHandlingMode.IGNORE
                                     ),
                                     new SelectorDimFilter("dim1", "abc", null)
                                 ),
                                 new FilteredAggregatorFactory(
                                     new FixedBucketsHistogramAggregatorFactory(
                                         "a5:agg", "fbhist_m1", 20, 0.0, 10.0, FixedBucketsHistogram.OutlierHandlingMode.IGNORE
                                     ),
                                     new NotDimFilter(new SelectorDimFilter("dim1", "abc", null))
                                 )
                             ))
