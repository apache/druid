...
public class OssDataSegmentArchiver extends OssDataSegmentMover implements DataSegmentArchiver {
    ...
    public DataSegment archive(DataSegment segment) throws SegmentLoadingException {
        ...
        String dstBucket = archiveConfig.getArchiveBucket();
        String dstBaseKey = archiveConfig.getArchiveBaseKey();
    ...
    public DataSegment restore(DataSegment segment) throws SegmentLoadingException {
        ...
        String dstBucket = restoreConfig.getBucket();
        String dstBaseKey = restoreConfig.getBaseKey();
