...
public class DefaultK8sApiClient implements K8sApiClient
{
  ...
  {
    try {
      V1PodList podList = coreV1Api.listNamespacedPod(podNamespace, null, null, null, null, labelSelector, null, null, null, null);
      ...
      Watch<V1Pod> watch =
          Watch.createWatch(
              ...
              coreV1Api.listNamespacedPodCall(namespace, null, true, null, null,
                                              labelSelector, null, lastKnownResourceVersion, null, true, null
              ),
