...
public class SketchMinBufferAggregator extends SketchIntersectionBufferAggregator{

	public SketchMinBufferAggregator(ObjectColumnSelector selector, List<FloatColumnSelector> selectors, int size,
