...
public class SketchMaxAggregator extends SketchIntersectionAggregator {

    public SketchMaxAggregator(String name, ObjectColumnSelector selector, List<FloatColumnSelector> selectors,
