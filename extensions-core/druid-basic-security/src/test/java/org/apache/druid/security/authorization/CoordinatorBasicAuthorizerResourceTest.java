...
public class CoordinatorBasicAuthorizerResourceTest
{
  ...
  public void testSeparateDatabaseTables()
  {
    ...
    Set<String> expectedGroups = ImmutableSet.of(
        "druidGroup",
        "druid2Group",
        "druid3Group"
    );

    Set<String> expectedGroups2 = ImmutableSet.of(
        "druid4Group",
        "druid5Group",
        "druid6Group"
    );
  ...
  @Test
  public void testUsersGroupsRolesAndPerms()
  {
    Response response = resource.createUser(req, AUTHORIZER_NAME, "druid");
    Assert.assertEquals(200, response.getStatus());
    ...
    Set<String> expectedGroupSet = Sets.newHashSet("druidGroup", "druid2Group");
