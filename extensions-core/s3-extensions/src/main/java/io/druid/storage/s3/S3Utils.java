...
public class S3Utils
{
  ...
  static boolean isObjectInBucketIgnoringPermission(EncryptingAmazonS3 s3Client, String bucketName, String objectKey)
  {
    try {
  ...
  public static Iterator<S3ObjectSummary> objectSummaryIterator(
      final EncryptingAmazonS3 s3Client,
      final String bucket,
      final String prefix,
  ...
  static AccessControlList grantFullControlToBucketOwner(EncryptingAmazonS3 s3Client, String bucket)
  {
   ...
   */
  public static S3ObjectSummary getSingleObjectSummary(EncryptingAmazonS3 s3Client, String bucket, String key)
  {
    final ListObjectsV2Request request = new ListObjectsV2Request()
        .withBucketName(bucket)
        .withPrefix(key)
