...
//  {
//    KinesisTuningConfig original = new KinesisTuningConfig(1, 2, new Period("PT3S"), new File("/tmp/xxx"), 4, new IndexSpec(), true, true, 5L, null);
//    KinesisTuningConfig copy = KinesisTuningConfig.copyOf(original);
//
