...
//{
//  private static final KinesisDataSourceMetadata KM0 = KM("foo", ImmutableMap.<Integer, Long>of());
...
//  }
//
//  private static KinesisDataSourceMetadata KM(String topic, Map<Integer, Long> offsets)
//  {
//    return new KinesisDataSourceMetadata(new KinesisPartitions(topic, offsets));
//  }
//}
