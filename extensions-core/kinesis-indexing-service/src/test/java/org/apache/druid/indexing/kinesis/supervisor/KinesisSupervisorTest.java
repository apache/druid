...
public class KinesisSupervisorTest extends EasyMockSupport
{
      ...
      throws InterruptedException, ExecutionException, TimeoutException, JsonProcessingException
  {
    ...
    EasyMock.expect(taskClient.getStatusAsync("id1")).andReturn(Futures.immediateFuture(SeekableStreamIndexTask.Status.READING));
      ...
      throws InterruptedException, ExecutionException, TimeoutException, JsonProcessingException
  {
    ...
    final Task id1 = createKinesisIndexTask(
        ...
        DATASOURCE,
        0,
        new SeekableStreamPartitions<>(stream, ImmutableMap.of(0, 0L)),
        new SeekableStreamPartitions<>(stream, ImmutableMap.of(0, Long.MAX_VALUE)),
        null,
        null
    );
