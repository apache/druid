...
public class JdbcDataPreFetcher extends PrefetchableFetcher<String, String>
{
  ...
  private final NavigableSet<String> sortedRangeKeys;

  public JdbcDataPreFetcher(
      ...
      )
  {
    ...
    this.rangeKeys = Preconditions.checkNotNull(rangeKeys, "rangeKeys");
    this.sortedRangeKeys = new TreeSet<>(this.rangeKeys);
  ...
  public Map<String, String> prefetch(String key)
  {
    ...
    if (range.lhs == null) {
      queryString = String.format(prefetchQueryToOnly, range.rhs);
    } else if (range.rhs == null) {
      queryString = String.format(prefetchQueryFromOnly, range.lhs);
    } else {
      queryString = String.format(prefetchQueryFromTo, range.lhs, range.rhs);
    }
  ...
  public boolean equals(Object o)
  {
    ...
    if (!(o instanceof JdbcDataPreFetcher)) {
      return false;
    }

    JdbcDataPreFetcher that = (JdbcDataPreFetcher) o;
  ...
  {
    String start = sortedRangeKeys.floor(key);
    String end = sortedRangeKeys.higher(key);
