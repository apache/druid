...
public class PrefetchedLoadingLookupFactory extends LoadingLookupFactory
{
  public PrefetchedLoadingLookupFactory(
      @JsonProperty("dataFetcher") PrefetchableFetcher prefetchableFetcher,
  ...
  public PrefetchedLoadingLookupFactory(
      ...
      PrefetchedLoadingLookup prefetchedLoadingLookup
  )
  {
    super(prefetchableFetcher, loadingCache, reverseLoadingCache, prefetchedLoadingLookup);
  }
}
