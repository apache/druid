...
//{
//  private ConjurerFirehoseFactory factory;
//
//
//    @Test
//  public void testMapIngestion() throws IOException
//    {
//      Map<String,Object> map = ImmutableMap.<String,Object>of("value1", 1.0f, "value2", "two", "time", "118215000");
//     ConjurerFirehoseFactory factory = new ConjurerFirehoseFactory(
//         new MyConjurerWrapper(map
//      )
//     );
...
//  }
//
//  private static class MyConjurerWrapper extends ConjurerWrapper
//  {
//    private static Map<String,Object> map;
//    public MyConjurerWrapper(Map<String,Object> map)
//    {
//      super(new ConjurerBuilder(null,null,null,null,null,null,true));
//      this.map = map;
//    }
//
