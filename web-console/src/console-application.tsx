...
> {
  ...
  static shownServiceNotification() {
    AppToaster.show({
      ...
      message: (
        <>
          It appears that some backend druid services are not responding. The console will not function at the moment.
          Please make sure that all the druid services are up and running. You can look at the logs of individual
