...
export const QUERY_CONTEXT_COMPLETIONS: JsonCompletionRule[] = [
  // Root level query context properties
  {
    ...
    completions: [
      ...
      { value: 'groupByEnableMultiValueUnnesting', documentation: 'Enable multi-value unnesting in GROUP BY' },
      ...
      { value: 'waitUntilSegmentsLoad', documentation: 'Wait for segments to load before completing' },
