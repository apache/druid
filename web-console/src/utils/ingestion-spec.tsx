    ...
    info: (
      <>
        ...
        <p>
          ...
          <ExternalLink href="http://druid.io/docs/latest/ingestion/data-formats.html">
            the documentation
          </ExternalLink>
          .
        </p>
...
const FLATTEN_FIELD_FORM_FIELDS: Field<FlattenField>[] = [
  ...
  },
  {
    ...
    info: (
      <>
        Specify a flatten{' '}
        <ExternalLink href="http://druid.io/docs/latest/ingestion/flatten-json">
          expression
        </ExternalLink>
        .
      </>
...
const TRANSFORM_FORM_FIELDS: Field<Transform>[] = [
  ...
  },
  {
    ...
    info: (
      <>
        A valid Druid{' '}
        <ExternalLink href="http://druid.io/docs/latest/misc/math-expr.html">
          expression
        </ExternalLink>
        .
      </>
    ...
    info: (
      <>
        <p>
          ...
          <ExternalLink href="http://druid.io/docs/latest/ingestion/firehose.html">
            firehoses
          </ExternalLink>
    ...
    case 'index:local':
      return [
        firehoseType,
        {
          ...
          info: (
            <>
              <ExternalLink href="http://druid.io/docs/latest/ingestion/firehose.html#localfirehose">
                firehose.baseDir
              </ExternalLink>
        ...
        firehoseType,
        {
          ...
          info: (
            <>
              <p>
                JSON array of{' '}
                <ExternalLink href="http://druid.io/docs/latest/development/extensions-contrib/google.html">
                  Google Blobs
                </ExternalLink>
                .
              </p>
      ...
      return [
        {
          ...
          info: (
            <>
              <ExternalLink href="http://druid.io/docs/latest/development/extensions-core/kafka-ingestion#kafkasupervisorioconfig">
                consumerProperties
              </ExternalLink>
              <p>
