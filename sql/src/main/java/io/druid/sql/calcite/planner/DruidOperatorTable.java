...
public class DruidOperatorTable implements SqlOperatorTable
{
  ...
  private static final List<SqlOperatorConversion> STANDARD_OPERATOR_CONVERSIONS =
      ImmutableList.<SqlOperatorConversion>builder()
          ...
          .add(new UnarySuffixOperatorConversion(SqlStdOperatorTable.IS_NULL, "== " + DruidExpression.nullLiteral()))
          .add(new UnarySuffixOperatorConversion(SqlStdOperatorTable.IS_NOT_NULL, "!= " + DruidExpression.nullLiteral()))
