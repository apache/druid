    ...
    public Enumerable<Object[]> scan(DataContext root)
    {
      ...
      final FluentIterable<Object[]> publishedSegments = FluentIterable
          ...
          .transform(val -> {
            ...
            // If druid.centralizedTableSchema.enabled is set on the Coordinator, SegmentMetadataCache on the
      ...
      // If druid.centralizedTableSchema.enabled is set on the Coordinator, all the segments in this loop
