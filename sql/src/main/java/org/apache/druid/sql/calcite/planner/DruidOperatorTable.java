...
import org.apache.druid.sql.calcite.external.AppendTableMacro;
...
{
  public static final SqlBasicFunction NVL =       SqlBasicFunction.create(SqlKind.NVL,
      ReturnTypes.LEAST_RESTRICTIVE
      .andThen(SqlTypeTransforms.TO_NULLABLE_ALL),
  OperandTypes.SAME_SAME).withDeterministic(true);
  ...
  private static final List<SqlOperatorConversion> STANDARD_OPERATOR_CONVERSIONS =
      ImmutableList.<SqlOperatorConversion>builder()
                   ...
                   .add(new CoalesceOperatorConversion(NVL))
                   ...
                   .add(AppendTableMacro.OPERATOR_CONVERSION)
                   .build();
