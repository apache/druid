...
public class CatalogIngestionDmlComponentSupplier extends IngestionDmlComponentSupplier
{
  ...
  public ImmutableMap<String, DruidTable> resolvedTables = ImmutableMap.of(
      ...
      "foo", new DatasourceTable(
          CalciteIngestionDmlTest.FOO_TABLE_SIGNATURE,
          new DatasourceTable.PhysicalDatasourceMetadata(
          ...
          new DatasourceTable.EffectiveMetadata(
              ...
              DatasourceTable.EffectiveMetadata.toEffectiveColumns(CalciteIngestionDmlTest.FOO_TABLE_SIGNATURE),
              false
          )
      ),
