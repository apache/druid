...
public class FileSqlRequestLoggerTest
{
  ...
  public void testLog() throws Exception
  {
    ...
    FileSqlRequestLogger fileRequestLogger = new FileSqlRequestLogger(objectMapper, scheduler, logDir);
    ...
    File logFile = new File(logDir, dateTime.toString("'sql.'yyyy-MM-dd'.log'"));
