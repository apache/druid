...
//  @Parameterized.Parameters(name = "{0}")
  ...
  public void ensureAllDeclared() throws Exception {
    ...
    for (Method method : DrillWindowQueryTest.class.getDeclaredMethods()) {
      DrillTestCase1 ann = method.getAnnotation(DrillTestCase1.class);
...
//  {
//    this.testCase = null;//new DrillTestCase(filename);
//  }
...
//  @Test
  ...
  {
    testCase=new DrillTestCase(value);
    windowQueryTest();

  }

  @DrillTestCase1( "lead_func/lead_Fn_76" )
  @Test
  ...
  }@DrillTestCase1( "lead_func/lead_Fn_22" )
  @Test
  ...
  }@DrillTestCase1( "ntile_func/ntileFn_30" )
  @Test
