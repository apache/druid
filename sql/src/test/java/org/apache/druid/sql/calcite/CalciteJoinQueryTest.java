...
public class CalciteJoinQueryTest extends BaseCalciteQueryTest
{
    ...
    testQuery(
        ...
        ImmutableList.of(
            GroupByQuery.builder()
                        ...
                        .setInterval(querySegmentSpec(Filtration.eternity()))
                        .setGranularity(Granularities.ALL)
                        .setDimFilter(or(selector("j0.v", null, null), not(selector("j0.v", "xa", null))))
    ...
    testQuery(
        ...
        ImmutableList.of(
            newScanQueryBuilder()
                ...
                .intervals(querySegmentSpec(Filtration.eternity()))
                .filters(or(selector("j0.v", null, null), not(selector("j0.v", "xa", null))))
                .columns("a0", "d0", "j0.v")
                .context(QUERY_CONTEXT_DEFAULT)
                .build()
        ),
    ...
    testQuery(
        ...
        ImmutableList.of(
            newScanQueryBuilder()
                ...
                .intervals(querySegmentSpec(Filtration.eternity()))
                .filters(or(selector("j0.v", null, null), not(selector("j0.v", "xxx", null))))
  ...
  public void testInnerJoinOnTwoInlineDataSourcesWithOuterWhere(Map<String, Object> queryContext)
  {
    ...
    testQuery(
        ...
        queryContext,
        ImmutableList.of(baseScanBuilder.build()),
        ImmutableList.of(
            new Object[]{"10.1", 946771200000L}
        )
    );
  ...
  public void testLeftJoinRightTableCanBeEmpty()
  {
    ...
    final DataSource rightTable = new QueryDataSource(
        Druids.newScanQueryBuilder()
              .dataSource(CalciteTests.DATASOURCE1)
              .intervals(querySegmentSpec(Filtration.eternity()))
              .resultFormat(ScanQuery.ResultFormat.RESULT_FORMAT_COMPACTED_LIST)
              .filters(new SelectorDimFilter("m2", "1000", null))
              .columns("dim2")
              .legacy(false)
              .build()
    );
