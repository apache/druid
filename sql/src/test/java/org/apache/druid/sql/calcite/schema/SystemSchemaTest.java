...
public class SystemSchemaTest extends CalciteTestBase
{
  ...
  public void testTasksTable() throws Exception
  {
    ...
    Assert.assertEquals("index_wikipedia_2018-09-20T22:33:44.911Z", row0[1].toString());
    ...
    Assert.assertEquals("index_wikipedia_2018-09-21T18:38:47.773Z", row1[1].toString());
