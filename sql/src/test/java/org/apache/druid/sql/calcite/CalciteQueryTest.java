...
public class CalciteQueryTest extends BaseCalciteQueryTest
{
  ...
  @Test
  public void testExplainUnionAllOfMultipleNativeQueries() throws Exception
  {
    skipVectorize();
  ...
  {
    PlannerConfig useLegacyDruidExplainConfig = new PlannerConfig()
    {
      @Override
    ...
    String explanationWithContext = "[{"
                                    ...
                                    + "\"columns\":[\"__time\",\"cnt\",\"dim1\",\"dim2\",\"dim3\",\"m1\",\"m2\",\"unique_dim1\"],"
                                    + "\"legacy\":false,"
                                    + "\"context\":{\"defaultTimeout\":300000,\"maxScatterGatherBytes\":9223372036854775807,\"sqlCurrentTimestamp\":\"2000-01-01T00:00:00Z\",\"sqlQueryId\":\"dummy\",\"useLegacyDruidExplain\":false},"
                                    + "\"descending\":false,"
                                    + "\"granularity\":{\"type\":\"all\"}},"
                                    + "\"signature\":\"{__time:LONG, cnt:LONG, dim1:STRING, dim2:STRING, dim3:STRING, m1:FLOAT, m2:DOUBLE, unique_dim1:COMPLEX<hyperUnique>}\"}]";
