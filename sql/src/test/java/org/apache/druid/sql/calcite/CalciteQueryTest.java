...
public class CalciteQueryTest extends BaseCalciteQueryTest
{
  ...
  public void testEarliestAggregators() throws Exception
  {
    ...
    testQuery(
        ...
        + "EARLIEST_BY(cnt, m1), EARLIEST_BY(m1, m1), EARLIEST_BY(dim1, m1, 10), "
        + "EARLIEST_BY(cnt + 1, m1), EARLIEST_BY(m1 + 1, m1), EARLIEST_BY(dim1 || CAST(cnt AS VARCHAR), m1, 10) "
        + "FROM druid.foo",
        ImmutableList.of(
            Druids.newTimeseriesQueryBuilder()
                  .dataSource(CalciteTests.DATASOURCE1)
  ...
  public void testLatestAggregators() throws Exception
  {
    ...
    testQuery(
        ...
        + "LATEST_BY(cnt, m1), LATEST_BY(m1, m1), LATEST_BY(dim1, m1, 10), "
        + "LATEST_BY(cnt + 1, m1), LATEST_BY(m1 + 1, m1), LATEST_BY(dim1 || CAST(cnt AS VARCHAR), m1, 10) "
        + "FROM druid.foo",
        ImmutableList.of(
            Druids.newTimeseriesQueryBuilder()
                  .dataSource(CalciteTests.DATASOURCE1)
