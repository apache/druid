...
public class CalciteQueryTest extends BaseCalciteQueryTest
{
  ...
  public void testExplainCountStarOnView() throws Exception
  {
    ...
    final String explanation =
        ...
        + "\"postAggregations\":[],"
        + "\"limit\":2147483647,"
        + "\"context\":{\"defaultTimeout\":300000,\"maxScatterGatherBytes\":9223372036854775807,\"skipEmptyBuckets\":true,\"sqlCurrentTimestamp\":\"2000-01-01T00:00:00Z\",\"vectorize\":\"false\"}}]"
        + ", signature=[{a0:LONG}])\n";
