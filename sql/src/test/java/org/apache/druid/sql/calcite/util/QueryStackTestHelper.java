...
public class QueryStackTestHelper
{
  ...
  public static JoinableFactory makeJoinableFactoryFromDefault(
      ...
      @Nullable final Set<JoinableFactory> customFactories,
      @Nullable final Map<Class<? extends JoinableFactory>, Class<? extends DataSource>> customMappings
  )
  {
    final ImmutableSet.Builder<JoinableFactory> setBuilder = ImmutableSet.builder();
    final ImmutableMap.Builder<Class<? extends JoinableFactory>, Class<? extends DataSource>> mapBuilder =
        ImmutableMap.builder();
    setBuilder.add(new InlineJoinableFactory(), new FrameBasedInlineJoinableFactory());
    mapBuilder.put(InlineJoinableFactory.class, org.apache.druid.query.InlineDataSource.class);
    mapBuilder.put(FrameBasedInlineJoinableFactory.class, org.apache.druid.query.FrameBasedInlineDataSource.class);
    if (lookupProvider != null) {
      setBuilder.add(new LookupJoinableFactory(lookupProvider));
      mapBuilder.put(LookupJoinableFactory.class, org.apache.druid.query.LookupDataSource.class);
    }
  ...
  {
    final Injector startupInjector = new StartupInjectorBuilder().build();
