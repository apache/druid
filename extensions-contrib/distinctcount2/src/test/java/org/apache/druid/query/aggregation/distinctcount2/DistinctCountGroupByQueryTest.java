...
public class DistinctCountGroupByQueryTest extends InitializedNullHandlingTest
{
  ...
  public void testGroupByWithDistinctCountAgg() throws Exception
  {
    ...
    GroupByQuery query = new GroupByQuery.Builder()
        ...
        .setAggregatorSpecs(QueryRunnerTestHelper.ROWS_COUNT, new DistinctCount2AggregatorFactory("UV", visitor_id, 12,
  ...
  {
    DistinctCount2AggregatorFactory aggregatorFactory = new DistinctCount2AggregatorFactory(
        "distinct",
        "visitor_id",
        12,
        TgtHllType.HLL_4.name()
