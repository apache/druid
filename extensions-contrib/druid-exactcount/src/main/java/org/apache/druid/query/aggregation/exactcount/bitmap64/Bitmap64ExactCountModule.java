...
import org.apache.druid.query.aggregation.exactcount.bitmap64.sql.Bitmap64ExactCountSqlAggregator;
    ...
    return Collections.singletonList(
        new SimpleModule("Bitmap64ExactCountModule")
            .registerSubtypes(
                ...
                new NamedType(Bitmap64ExactCountPostAggregator.class, "bitmap64ExactCountCardinality")
            )
            .addSerializer(
