 ...
 *
 * Each file has > 1024 rows, ensuring the Delta kernel reads more than one batch
 * per file. Used as a regression test for GH-18606 (DeltaInputSourceIterator only
 * returned the first 1024 rows per file).
 *
...
public class LargeRowGroupDeltaTable
{
  ...
  public static final org.apache.druid.data.input.InputRowSchema SCHEMA =
      new org.apache.druid.data.input.InputRowSchema(
          new TimestampSpec("id", "posix", null),
          new DimensionsSpec(Arrays.asList(
