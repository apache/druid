...
public class DruidOrcIndexGeneratorJobTest
{
  ...
  private final InputRowParser inputRowParser = new DruidOrcHadoopInputRowParser(
  ...
  public void setUp() throws Exception
  {
    ...
    inputSpec.put("inputFormat", "org.apache.druid.data.input.orc.DruidOrcNewInputFormat");
