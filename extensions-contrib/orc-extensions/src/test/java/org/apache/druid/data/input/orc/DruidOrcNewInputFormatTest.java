...
public class DruidOrcNewInputFormatTest
{
  @Rule
  ...
  public void setUp() throws IOException
  {
    ...
    config = HadoopDruidIndexerConfig.fromFile(new File(
        "example/hadoop_druid_orc_job.json"));
  ...
  public void testRead() throws IOException, InterruptedException
  {
    ...
    InputRowParser<Map<String, Object>> parser = (InputRowParser<Map<String, Object>>) config.getParser();
    ...
    Assert.assertEquals(data, row.getEvent());
