...
public class NameNumberedCleanupOvershadowedTest
{
  ...
  private DataSegment segmentV0 = new DataSegment.Builder().dataSource("test")
      ...
      .version("0")
      .shardSpec(new NamedNumberedShardSpec(0, 1, "onsite"))
      .build();
  ...
  private DataSegment segmentV2 = new DataSegment.Builder().dataSource("test")
      ...
      .shardSpec(new NamedNumberedShardSpec(0, 1, "onsite"))
      .build();
  private DataSegment segmentV3 = new DataSegment.Builder().dataSource("test")
      .interval(new Interval(start, start.plusHours(1)))
      .version("0")
      .shardSpec(new NamedNumberedShardSpec(0, 1, "doc"))
      .build();
  private DataSegment segmentV4 = new DataSegment.Builder().dataSource("test")
      .interval(new Interval(start, start.plusHours(1)))
      .version("1")
      .shardSpec(new NamedNumberedShardSpec(0, 1, "doc"))
      .build();
  private DataSegment segmentV5 = new DataSegment.Builder().dataSource("test")
      .interval(new Interval(start, start.plusHours(1)))
      .version("2")
      .shardSpec(new NamedNumberedShardSpec(0, 1, "doc"))
      .build();
