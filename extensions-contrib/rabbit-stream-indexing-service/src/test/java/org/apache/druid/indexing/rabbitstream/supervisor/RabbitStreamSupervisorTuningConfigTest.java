...
public class RabbitStreamSupervisorTuningConfigTest
{
  ...
  public void testRequireRestartWhenRabbitTaskTuningChanges()
  {
    ...
    Assert.assertTrue(supervisorSpec(tuningConfig(20, 16, 17)).requireRestart(oldSpec));
    Assert.assertTrue(supervisorSpec(tuningConfig(15, 20, 17)).requireRestart(oldSpec));
    Assert.assertTrue(supervisorSpec(tuningConfig(15, 16, 20)).requireRestart(oldSpec));
  }
