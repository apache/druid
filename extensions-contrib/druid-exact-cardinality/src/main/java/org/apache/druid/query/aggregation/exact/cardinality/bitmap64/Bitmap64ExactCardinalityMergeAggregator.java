...
public class Bitmap64ExactCardinalityMergeAggregator implements Aggregator
{
  private final ColumnValueSelector<Bitmap64Counter> selector;
  private Bitmap64Counter bitmap;

  public Bitmap64ExactCardinalityMergeAggregator(ColumnValueSelector<Bitmap64Counter> selector)
  {
