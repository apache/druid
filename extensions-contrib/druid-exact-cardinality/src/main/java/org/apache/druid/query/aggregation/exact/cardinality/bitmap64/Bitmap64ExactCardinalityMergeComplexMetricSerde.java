...
public class Bitmap64ExactCardinalityMergeComplexMetricSerde extends ComplexMetricSerde
{
  ...
  {
    return Bitmap64ExactCardinalityModule.TYPE_NAME; // must be common type name
  }

  @Override
  public ObjectStrategy getObjectStrategy()
  {
    return Bitmap64ExactCardinalityObjectStrategy.STRATEGY;
  }
  ...
  public void deserializeColumn(final ByteBuffer buf, final ColumnBuilder columnBuilder)
  {
    columnBuilder.setComplexColumnSupplier(
        new ComplexColumnPartSupplier(
            getTypeName(),
            GenericIndexed.read(buf, Bitmap64ExactCardinalityObjectStrategy.STRATEGY, columnBuilder.getFileMapper())
        )
    );
  }
