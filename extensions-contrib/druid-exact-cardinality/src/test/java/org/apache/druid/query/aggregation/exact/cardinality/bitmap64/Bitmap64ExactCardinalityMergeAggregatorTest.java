...
public class Bitmap64ExactCardinalityMergeAggregatorTest
{
  private ColumnValueSelector<Bitmap64Counter> mockSelector;
  private Bitmap64ExactCardinalityMergeAggregator aggregator;

  @BeforeEach
  public void setUp()
  {
    mockSelector = EasyMock.createMock(ColumnValueSelector.class);
    aggregator = new Bitmap64ExactCardinalityMergeAggregator(mockSelector);
  }
