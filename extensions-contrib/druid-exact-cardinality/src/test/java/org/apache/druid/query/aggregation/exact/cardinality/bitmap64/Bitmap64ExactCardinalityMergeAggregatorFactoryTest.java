...
public class Bitmap64ExactCardinalityMergeAggregatorFactoryTest
{
  private static final String NAME = "exactCardinalityMergeTestName";
  private static final String FIELD_NAME = "exactCardinalityMergeTestFieldName";

  private Bitmap64ExactCardinalityMergeAggregatorFactory factory;

  @BeforeEach
  public void setUp()
  {
    factory = new Bitmap64ExactCardinalityMergeAggregatorFactory(NAME, FIELD_NAME);
  }
  ...
  {
    Assertions.assertEquals(AggregatorUtil.BITMAP64_EXACT_CARDINALITY_MERGE_CACHE_TYPE_ID, factory.getCacheTypeId());
  }
  ...
  public void testFactorize()
  {
    ...
    EasyMock.expect(selectorFactory.makeColumnValueSelector(FIELD_NAME))
            .andReturn(new TestObjectColumnSelector<Bitmap64Counter>(null)); // Return a dummy selector
    EasyMock.replay(selectorFactory);

    Assertions.assertInstanceOf(Bitmap64ExactCardinalityMergeAggregator.class, factory.factorize(selectorFactory));
  ...
  public void testFactorizeBuffered()
  {
    ...
    Assertions.assertInstanceOf(
        Bitmap64ExactCardinalityMergeBufferAggregator.class,
