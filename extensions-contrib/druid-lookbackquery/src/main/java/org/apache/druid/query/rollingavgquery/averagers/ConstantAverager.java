...
public class ConstantAverager implements Averager<Float>
{
  ...
  /* (non-Javadoc)
   * @see com.yahoo.digits.druid.rollingavgquery.averagers.Averager#getResult()
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see com.yahoo.digits.druid.rollingavgquery.averagers.Averager#getName()
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see com.yahoo.digits.druid.rollingavgquery.averagers.Averager#skip()
   */
  @Override
  public void skip()
  {
