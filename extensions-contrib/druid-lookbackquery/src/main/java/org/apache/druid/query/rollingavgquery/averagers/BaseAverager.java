...
public abstract class BaseAverager<I, R extends Object> implements Averager<R>
{
  ...
  public BaseAverager(Class<I> storageType, int numBuckets, String name, String fieldName, int period)
  {
    this(storageType, numBuckets, name, fieldName, period, true);
  }


  /* (non-Javadoc)
   * @see com.yahoo.digits.druid.rollingavgquery.averagers.Averager#addElement(java.util.Map, java.util.Map)
   */
  @SuppressWarnings("unchecked")
  @Override
