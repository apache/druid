...
public interface RollingAverageQueryMetrics extends QueryMetrics<RollingAverageQuery>
{
  /**
   * Sets the size of {@link RollingAverageQuery#getDimensions()} of the given query as dimension.
   */
  void numDimensions(RollingAverageQuery query);

  /**
   * Sets the number of metrics of the given groupBy query as dimension.
   */
  void numMetrics(RollingAverageQuery query);
   ...
   * method.
   */
  void numComplexMetrics(RollingAverageQuery query);
}
