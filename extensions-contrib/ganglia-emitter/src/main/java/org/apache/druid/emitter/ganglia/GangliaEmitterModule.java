...
public class GangliaEmitterModule implements DruidModule
{
  ...
  {
    JsonConfigProvider.bind(binder, "druid.emitter." + EMITTER_TYPE, GangliaEmitterConfig.class);
  }

  @Provides
  @ManageLifecycle
  @Named(EMITTER_TYPE)
  public Emitter getEmitter(GangliaEmitterConfig gangliaEmitterConfig, ObjectMapper mapper)
      throws IOException
  {
