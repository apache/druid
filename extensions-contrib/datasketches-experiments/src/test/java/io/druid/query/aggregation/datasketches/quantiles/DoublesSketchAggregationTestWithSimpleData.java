...
/**
 */
public class DoublesSketchAggregationTestWithSimpleData
{
  @Rule
  ...
  public final static String readFileFromClasspathAsString(String fileName) throws IOException
  {
    return Files.asCharSource(
        new File(DoublesSketchAggregationTestWithSimpleData.class.getClassLoader().getResource(fileName).getFile()),
