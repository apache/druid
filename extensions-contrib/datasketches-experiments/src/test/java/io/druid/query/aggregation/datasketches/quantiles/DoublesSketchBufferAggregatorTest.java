...
/**
 */
public class DoublesSketchBufferAggregatorTest
{
  @Test
  public void testAggregation() throws Exception
  {
    final int maxOffheapSize = 1<<12;
    DoublesSketchBufferAggregator aggregator = new DoublesSketchBufferAggregator(
    ...
    DoublesSketch sketch = ((DoublesSketchHolder) aggregator.get(bb, 0)).getSketch();
