...
public class RocketMQSamplerSpecTest extends InitializedNullHandlingTest
{
  ...
  public void testSample() throws InterruptedException, RemotingException, MQClientException, MQBrokerException
  {
    insertData(generateRecords(TOPIC));

    RocketMQSupervisorSpec supervisorSpec = new RocketMQSupervisorSpec(
        null,
        DATA_SCHEMA,
        null,
        new RocketMQSupervisorIOConfig(
            TOPIC,
    ...
    RocketMQSamplerSpec samplerSpec = new RocketMQSamplerSpec(
        supervisorSpec,
