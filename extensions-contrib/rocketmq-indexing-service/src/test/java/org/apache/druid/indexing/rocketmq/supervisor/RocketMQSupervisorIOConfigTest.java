...
public class RocketMQSupervisorIOConfigTest
{
  ...
  public RocketMQSupervisorIOConfigTest()
  {
  ...
  public void testSerdeWithDefaults() throws Exception
  {
    ...
    RocketMQSupervisorIOConfig config = mapper.readValue(
        mapper.writeValueAsString(
            mapper.readValue(
                jsonStr,
                RocketMQSupervisorIOConfig.class
            )
        ), RocketMQSupervisorIOConfig.class
    );
  ...
  public void testTopicRequired() throws Exception
  {
    ...
    mapper.readValue(jsonStr, RocketMQSupervisorIOConfig.class);
  }
  ...
  public void testBootstrapServersRequired() throws Exception
  {
    ...
    exception.expect(JsonMappingException.class);
    exception.expectCause(CoreMatchers.isA(NullPointerException.class));
    exception.expectMessage(CoreMatchers.containsString("nameserver.url"));
    mapper.readValue(jsonStr, RocketMQSupervisorIOConfig.class);
  }
