...
public class RocketMQSupervisorTuningConfigTest
{
  private final ObjectMapper mapper;

  public RocketMQSupervisorTuningConfigTest()
  {
  ...
  {
    String jsonStr = "{\"type\": \"rocketmq\"}";

    RocketMQSupervisorTuningConfig config = (RocketMQSupervisorTuningConfig) mapper.readValue(
