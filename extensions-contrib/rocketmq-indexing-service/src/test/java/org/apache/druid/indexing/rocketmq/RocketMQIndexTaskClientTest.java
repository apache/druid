...
public class RocketMQIndexTaskClientTest extends EasyMockSupport
{
  @Rule
  ...
  private RocketMQIndexTaskClient client;
  ...
  public RocketMQIndexTaskClientTest(int numThreads)
  {
  ...
  public void setUp()
  {
    ...
    client = new TestableRocketMQIndexTaskClient(httpClient, OBJECT_MAPPER, taskInfoProvider);
  ...
  public void testTaskLocationMismatch()
  {
    ...
    Map<String, Long> results = client.getCurrentOffsets(TEST_ID, true);
    verifyAll();
  ...
  {
    client = new TestableRocketMQIndexTaskClient(httpClient, OBJECT_MAPPER, taskInfoProvider, 3);
  ...
  public void testGetCurrentOffsetsWithExhaustedRetries()
  {
    ...
    client = new TestableRocketMQIndexTaskClient(httpClient, OBJECT_MAPPER, taskInfoProvider, 2);
  ...
  public void testGetEndOffsets() throws Exception
  {
    ...
    Map<String, Long> results = client.getEndOffsets(TEST_ID);
    verifyAll();
  ...
  public void testPause() throws Exception
  {
    ...
    Map<String, Long> results = client.pause(TEST_ID);
    verifyAll();
  ...
  public void testPauseWithSubsequentGetOffsets() throws Exception
  {
    ...
    // one time in IndexTaskClient.submitRequest() and another in RocketMQIndexTaskClient.pause()
  ...
  private class TestableRocketMQIndexTaskClient extends RocketMQIndexTaskClient
  {
    TestableRocketMQIndexTaskClient(
