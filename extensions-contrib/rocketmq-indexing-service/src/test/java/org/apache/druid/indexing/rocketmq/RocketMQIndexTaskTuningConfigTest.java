...
import org.apache.druid.indexing.rocketmq.test.TestModifiedRocketMQIndexTaskTuningConfig;
...
public class RocketMQIndexTaskTuningConfigTest
{
  private final ObjectMapper mapper;

  public RocketMQIndexTaskTuningConfigTest()
  {
  ...
  public void testSerdeWithDefaults() throws Exception
  {
    ...
    RocketMQIndexTaskTuningConfig config = (RocketMQIndexTaskTuningConfig) mapper.readValue(
  ...
  {
    RocketMQSupervisorTuningConfig original = new RocketMQSupervisorTuningConfig(
        null,
        1,
        null,
        null,
    ...
    RocketMQIndexTaskTuningConfig copy = (RocketMQIndexTaskTuningConfig) original.convertToTaskTuningConfig();
  ...
  {
    RocketMQIndexTaskTuningConfig base = new RocketMQIndexTaskTuningConfig(
        null,
        1,
        null,
        null,
    ...
    TestModifiedRocketMQIndexTaskTuningConfig deserialized =
        mapper.readValue(serialized, TestModifiedRocketMQIndexTaskTuningConfig.class);
  ...
  {
    TestModifiedRocketMQIndexTaskTuningConfig base = new TestModifiedRocketMQIndexTaskTuningConfig(
        null,
        1,
        null,
        null,
    ...
    String serialized = mapper.writeValueAsString(base);
    RocketMQIndexTaskTuningConfig deserialized =
        mapper.readValue(serialized, RocketMQIndexTaskTuningConfig.class);
  ...
  {
    EqualsVerifier.forClass(RocketMQIndexTaskTuningConfig.class)
        .usingGetClass()
        .verify();
  }
}
