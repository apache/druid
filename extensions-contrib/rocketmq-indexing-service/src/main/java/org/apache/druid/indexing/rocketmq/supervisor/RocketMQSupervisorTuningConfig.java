...
public class RocketMQSupervisorTuningConfig extends RocketMQIndexTaskTuningConfig
    implements SeekableStreamSupervisorTuningConfig
{
  ...
  public static RocketMQSupervisorTuningConfig defaultConfig()
  {
    return new RocketMQSupervisorTuningConfig(
        null,
        null,
        null,
        null,
  ...
  public RocketMQSupervisorTuningConfig(
  ...
  {
    // Stopping tasks early for RocketMQ ingestion on partition set change is not supported yet,
  ...
  {
    return "RocketMQSupervisorTuningConfig{" +
  ...
  @Override
  public RocketMQIndexTaskTuningConfig convertToTaskTuningConfig()
  {
