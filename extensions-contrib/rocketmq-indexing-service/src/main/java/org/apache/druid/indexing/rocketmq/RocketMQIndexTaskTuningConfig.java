...
public class RocketMQIndexTaskTuningConfig extends SeekableStreamIndexTaskTuningConfig
{
  @JsonCreator
  public RocketMQIndexTaskTuningConfig(
  ...
  @Override
  public RocketMQIndexTaskTuningConfig withBasePersistDirectory(File dir)
  {
    return new RocketMQIndexTaskTuningConfig(
  ...
  {
    return "RocketMQIndexTaskTuningConfig{" +
