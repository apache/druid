...
public class DropwizardEmitterModule implements DruidModule
{
    ...
    @ManageLifecycle
    @Named(EMITTER_TYPE)
    public Emitter getEmitter(DropwizardEmitterConfig dropwizardEmitterConfig, ObjectMapper mapper, final Injector injector){
        ...
        return new DropwizardEmitter(dropwizardEmitterConfig, emitters);
    }
}
