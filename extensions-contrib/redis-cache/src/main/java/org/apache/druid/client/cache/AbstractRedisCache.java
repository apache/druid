...
public abstract class AbstractRedisCache implements Cache
{
  ...
  public void doMonitor(ServiceEmitter emitter)
  {
    ...
    emitter.emit(builder.setMetricAndValue("query/cache/redis/total/requests", totalCount));
    emitter.emit(builder.setMetricAndValue("query/cache/redis/delta/requests", totalCount - priorCount));
