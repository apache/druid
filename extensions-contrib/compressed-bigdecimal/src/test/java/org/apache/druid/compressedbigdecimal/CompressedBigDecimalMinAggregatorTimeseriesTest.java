 ...
 */
public class CompressedBigDecimalMinAggregatorTimeseriesTest
{
  ...
  /**
     * Constructor.
   * * */
  public CompressedBigDecimalMinAggregatorTimeseriesTest()
  {
  ...
  */
  ...
  public void testIngestAndTimeseriesQuery() throws IOException, Exception
  {
    Sequence seq = helper.createIndexAndRunQueryOnSegment(
            ...
            Resources.asCharSource(getClass().getResource(
                ...
                5,
                Resources.asCharSource(
                        this.getClass().getResource("/" + "bd_min_test_timeseries_query.json"),
                        StandardCharsets.UTF_8
                ).read()
        );
    ...
    assertThat(event, hasEntry("cbdStringRevenue", new ArrayCompressedBigDecimal(new BigDecimal("-1.000000000"))));
  }
  ...
  public void testIngestMultipleSegmentsAndTimeseriesQuery() throws Exception
  {
    ...
    helper.createIndex(
            ...
            Resources.asCharSource(this.getClass().getResource("/" + "bd_min_test_aggregators.json"),
                    StandardCharsets.UTF_8).read(),
            segmentDir1,
            0,
            Granularities.NONE,
