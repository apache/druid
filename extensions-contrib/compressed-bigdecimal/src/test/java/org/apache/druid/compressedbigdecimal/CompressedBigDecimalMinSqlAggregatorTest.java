...
public class CompressedBigDecimalMinSqlAggregatorTest extends BaseCalciteQueryTest
{
  ...
  public void testCompressedBigDecimalAggWithNumberParse()
  {
    cannotVectorize();
    testQuery(
        "SELECT big_min(m1, 9, 9), big_min(m2, 9, 9), big_min(dim1, 9, 9, false) FROM foo",
        Collections.singletonList(
            Druids.newTimeseriesQueryBuilder()
                  ...
                  .aggregators(
                      new CompressedBigDecimalMinAggregatorFactory("a0:agg", "m1", 9, 9, false),
                      new CompressedBigDecimalMinAggregatorFactory("a1:agg", "m2", 9, 9, false),
                      new CompressedBigDecimalMinAggregatorFactory("a2:agg", "dim1", 9, 9, false)
                  )
  ...
  public void testCompressedBigDecimalAggWithStrictNumberParse()
  {
    cannotVectorize();
    testQuery(
        "SELECT big_min(dim1, 9, 9, true) FROM foo",
        Collections.singletonList(
            Druids.newTimeseriesQueryBuilder()
                  .dataSource(CalciteTests.DATASOURCE1)
                  .intervals(new MultipleIntervalSegmentSpec(ImmutableList.of(Filtration.eternity())))
                  .granularity(Granularities.ALL)
                  .aggregators(
                      new CompressedBigDecimalMinAggregatorFactory("a0:agg", "dim1", 9, 9, true)
                  )
                  .context(QUERY_CONTEXT_DEFAULT)
                  .build()
        ),
  ...
  public void testCompressedBigDecimalAggDefaultNumberParse()
  {
    cannotVectorize();
    testQuery(
        "SELECT big_min(m1, 9, 9), big_min(m2, 9, 9), big_min(dim1, 9, 9) FROM foo",
        Collections.singletonList(
            Druids.newTimeseriesQueryBuilder()
                  .dataSource(CalciteTests.DATASOURCE1)
                  .intervals(new MultipleIntervalSegmentSpec(ImmutableList.of(Filtration.eternity())))
  ...
  public void testCompressedBigDecimalAggDefaultScale()
  {
    cannotVectorize();
    testQuery(
        "SELECT big_min(m1, 9), big_min(m2, 9), big_min(dim1, 9) FROM foo",
        Collections.singletonList(
            Druids.newTimeseriesQueryBuilder()
                  .dataSource(CalciteTests.DATASOURCE1)
                  .intervals(new MultipleIntervalSegmentSpec(ImmutableList.of(Filtration.eternity())))
  ...
  public void testCompressedBigDecimalAggDefaultSizeAndScale()
  {
    cannotVectorize();
    testQuery(
        "SELECT big_min(m1), big_min(m2), big_min(dim1) FROM foo",
        Collections.singletonList(
            Druids.newTimeseriesQueryBuilder()
                  .dataSource(CalciteTests.DATASOURCE1)
                  .intervals(new MultipleIntervalSegmentSpec(ImmutableList.of(Filtration.eternity())))
                  .granularity(Granularities.ALL)
                  .aggregators(
                      new CompressedBigDecimalMinAggregatorFactory("a0:agg", "m1", 6, 9, false),
                      new CompressedBigDecimalMinAggregatorFactory("a1:agg", "m2", 6, 9, false),
                      new CompressedBigDecimalMinAggregatorFactory("a2:agg", "dim1", 6, 9, false)
                  )
                  .context(QUERY_CONTEXT_DEFAULT)
                  .build()
        ),
