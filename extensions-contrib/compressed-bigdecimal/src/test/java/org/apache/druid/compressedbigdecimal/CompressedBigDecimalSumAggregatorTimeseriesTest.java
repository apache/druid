 ...
 */
public class CompressedBigDecimalSumAggregatorTimeseriesTest
{
   ...
   * *
   */
  public CompressedBigDecimalSumAggregatorTimeseriesTest()
  {
  ...
  public void testIngestAndTimeseriesQuery() throws IOException, Exception
  {
    Sequence seq = helper.createIndexAndRunQueryOnSegment(
        ...
        Resources.asCharSource(
            this.getClass().getResource("/" + "bd_sum_test_aggregators.json"),
            StandardCharsets.UTF_8
        ).read(),
        0,
        Granularities.NONE,
        5,
        Resources.asCharSource(
            this.getClass().getResource("/" + "bd_sum_test_timeseries_query.json"),
            StandardCharsets.UTF_8
        ).read()
    );
    ...
    assertThat(
        event,
        hasEntry("cbdStringRevenue", new ArrayCompressedBigDecimal(new BigDecimal("15000000010.000000005")))
    );
  }
