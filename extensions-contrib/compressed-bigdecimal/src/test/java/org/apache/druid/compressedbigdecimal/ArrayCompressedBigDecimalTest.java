...
public class ArrayCompressedBigDecimalTest
{
  ...
  public void testCompareToOptimization()
  {
    ArrayCompressedBigDecimal d1 = ArrayCompressedBigDecimal.allocateZero(
        CompressedBigDecimalSumAggregatorFactory.DEFAULT_SIZE,
        CompressedBigDecimalSumAggregatorFactory.DEFAULT_SCALE
    );
  ...
  public void testCompareToFailOptimized()
  {
    ...
    ArrayCompressedBigDecimal d2 = ArrayCompressedBigDecimal.allocateZero(
        CompressedBigDecimalSumAggregatorFactory.DEFAULT_SIZE,
        CompressedBigDecimalSumAggregatorFactory.DEFAULT_SCALE + 1
        );
  ...
  {
    ArrayCompressedBigDecimal d1 = ArrayCompressedBigDecimal.allocateZero(
        CompressedBigDecimalSumAggregatorFactory.DEFAULT_SIZE + 1,
        CompressedBigDecimalSumAggregatorFactory.DEFAULT_SCALE
    );
    ArrayCompressedBigDecimal d2 = ArrayCompressedBigDecimal.allocateZero(
        CompressedBigDecimalSumAggregatorFactory.DEFAULT_SIZE + 2,
        CompressedBigDecimalSumAggregatorFactory.DEFAULT_SCALE
        );
    ArrayCompressedBigDecimal d3 = ArrayCompressedBigDecimal.allocateZero(
        CompressedBigDecimalSumAggregatorFactory.DEFAULT_SIZE + 3,
        CompressedBigDecimalSumAggregatorFactory.DEFAULT_SCALE
        );
    ArrayCompressedBigDecimal d4 = ArrayCompressedBigDecimal.allocateZero(
        CompressedBigDecimalSumAggregatorFactory.DEFAULT_SIZE + 4,
        CompressedBigDecimalSumAggregatorFactory.DEFAULT_SCALE
    );
    // leave this as 0
    ArrayCompressedBigDecimal d5 = ArrayCompressedBigDecimal.allocateZero(
        CompressedBigDecimalSumAggregatorFactory.DEFAULT_SIZE + 5,
        CompressedBigDecimalSumAggregatorFactory.DEFAULT_SCALE
    );
