...
/**
 * Unit tests for {@link CompressedBigDecimalSumAggregatorFactory}.
 */
@RunWith(Parameterized.class)
public class CompressedBigDecimalSumAggregatorGroupByTest
{
   ...
   */
  public CompressedBigDecimalSumAggregatorGroupByTest(GroupByQueryConfig config)
  {
  ...
  public void testIngestAndGroupByAllQuery() throws IOException, Exception
  {
    String groupByQueryJson = Resources.asCharSource(
        this.getClass().getResource("/" + "bd_sum_test_groupby_query.json"),
    ...
    Assert.assertThat(
        ...
        IsMapContaining.hasEntry(
            ...
            new ArrayCompressedBigDecimal(new BigDecimal("15000000010.000000005"))
        )
    );
    ...
    Assert.assertThat(
        ...
        IsMapContaining.hasEntry(
            "cbdRevenueFromLong",
            new ArrayCompressedBigDecimal(new BigDecimal("10000000010.000000000"))
        )
    );
    ...
    Assert.assertThat(
        ...
        IsMapContaining.hasEntry(
            ...
            new ArrayCompressedBigDecimal(new BigDecimal("15000000010.500000000"))
        )
    );
  }
}
