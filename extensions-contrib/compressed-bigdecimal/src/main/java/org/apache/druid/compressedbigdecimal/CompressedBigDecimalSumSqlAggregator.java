...
public class CompressedBigDecimalSumSqlAggregator implements SqlAggregator
{
  private static final SqlAggFunction FUNCTION_INSTANCE = new CompressedBigDecimalSumSqlAggFunction();
  ...
  )
  {
    ...
    // create the factory
    AggregatorFactory aggregatorFactory = new CompressedBigDecimalSumAggregatorFactory(
  ...
  private static class CompressedBigDecimalSumSqlAggFunction extends SqlAggFunction
  {
    ...
    CompressedBigDecimalSumSqlAggFunction()
    {
      super(
          NAME,
          null,
