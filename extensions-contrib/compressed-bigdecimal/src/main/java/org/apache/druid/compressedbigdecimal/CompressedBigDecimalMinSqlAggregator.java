...
public class CompressedBigDecimalMinSqlAggregator implements SqlAggregator
{
  private static final SqlAggFunction FUNCTION_INSTANCE = new CompressedBigDecimalMinSqlAggFunction();
  private static final String NAME = "BIG_MIN";
  ...
  )
  {
    ...
    // create the factory
    AggregatorFactory aggregatorFactory = new CompressedBigDecimalMinAggregatorFactory(
  ...
  private static class CompressedBigDecimalMinSqlAggFunction extends SqlAggFunction
  {
    ...
    CompressedBigDecimalMinSqlAggFunction()
    {
      super(
          NAME,
          null,
