...
import org.apache.druid.k8s.overlord.execution.KubernetesResource;
...
public class KubernetesOverlordModule implements DruidModule
{
  ...
  public void configure(Binder binder)
  {
    ...
    JacksonConfigProvider.bind(binder, ExecutionConfig.CONFIG_KEY, ExecutionConfig.class, null);
