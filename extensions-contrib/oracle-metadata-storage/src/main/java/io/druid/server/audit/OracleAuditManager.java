...
public class OracleAuditManager implements AuditManager
{
  ...
  public void doAudit(AuditEntry auditEntry, Handle handle) throws IOException
  {
    ...
    handle.createStatement(
        StringUtils.format(
            "INSERT INTO %1$s (id, audit_key, type, author, %2$scomment%2$s, created_date, payload) VALUES (%1$s_seq.nextval, :audit_key, :type, :author, :comment, :created_date, :payload)",
            getAuditTable(), connector.getQuoteString()
        )
    )
