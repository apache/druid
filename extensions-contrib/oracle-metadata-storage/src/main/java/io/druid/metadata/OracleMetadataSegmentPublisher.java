...
public class OracleMetadataSegmentPublisher implements MetadataSegmentPublisher
{
  private static final Logger log = new Logger(OracleMetadataSegmentPublisher.class);
  ...
  @Inject
  public OracleMetadataSegmentPublisher(
          ...
          new HandleCallback<Void>()
          {
            ...
            public Void withHandle(Handle handle) throws Exception
            {
              handle.createStatement(statement)
                    ...
                    .bind("start", start)
                    .bind("end", end)
                    .bind("partitioned", partitioned ? "true" : "false")
