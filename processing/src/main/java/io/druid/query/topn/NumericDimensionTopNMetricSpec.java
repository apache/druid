...
public class NumericDimensionTopNMetricSpec extends LexicographicTopNMetricSpec
{
  private static final byte CACHE_TYPE_ID = 0x4;

  protected static Comparator<String> comparator = StringComparators.NUMERIC;

  @JsonCreator
  public NumericDimensionTopNMetricSpec(
  ...
  {
    return "NumericDimensionTopNMetricSpec{" +
