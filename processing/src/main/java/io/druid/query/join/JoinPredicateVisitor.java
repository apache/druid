...
public interface JoinPredicateVisitor
{
  ...
  default JoinPredicate visit(NotPredicate predicate)
  {
    predicate.getBase().accept(this);
    return predicate;
  }
  ...
  default JoinPredicate visit(LiteralPredicate predicate)
  {
    return predicate;
  }
}
