...
/**
 */
public class FloatSumAggregatorFactory implements AggregatorFactory
{
  ...
  {
    return new FloatSumBufferAggregator(metricFactory.makeFloatColumnSelector(fieldName));
  }
  ...
  {
    return Arrays.<AggregatorFactory>asList(new FloatSumAggregatorFactory(fieldName, fieldName));
  }
