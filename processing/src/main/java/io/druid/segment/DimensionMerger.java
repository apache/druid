...
public interface DimensionMerger
{
   ...
   * during mergeValueMetadataAcrossSegments, if applicable.
   *
   ...
   * determined during mergeValueMetadataAcrossSegments().
   *
   ...
   * corresponds to the position of segment adapters within the input list of mergeValueMetadataAcrossSegments().
   *
