...
public abstract class Directory implements Closeable
{
   ...
   * temporary random file name including prefix and suffix.  Use
  ...
  /**
   * Closes the store,clear all the content of this directory and remove this directory.
   */
  @Override
  public abstract void close() throws IOException;

  /**
   * clear the contents of this directory to be an empty one
   * @throws IOException
   */
