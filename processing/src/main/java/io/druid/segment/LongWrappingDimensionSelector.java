...
public class LongWrappingDimensionSelector implements DimensionSelector
{
  ...
  {
    float rowValLong = delegate.get();
    String rowVal = exFn != null ? exFn.apply(rowValLong) : String.valueOf(rowValLong) ;
    ...
    return new IndexedInts()
    {
      ...
      {
        throw new UnsupportedOperationException("wrapped long does not support fill");
      }
  ...
  {
    throw new UnsupportedOperationException("wrapped long column does not support lookups");
  }
}
