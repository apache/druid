...
public class GenericIndexedWriterV2<T> extends GenericIndexedWriter<T>
{
  public GenericIndexedWriterV2(IOPeon ioPeon, String filenameBase, ObjectStrategy<T> strategy)
  {
    super(ioPeon, filenameBase, strategy, 0x2);
  }
