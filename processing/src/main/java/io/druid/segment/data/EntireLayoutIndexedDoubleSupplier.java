...
public class EntireLayoutIndexedDoubleSupplier implements Supplier<IndexedDoubles>
{
  ...
  public EntireLayoutIndexedDoubleSupplier(int totalSize, ByteBuffer fromBuffer, ByteOrder order)
  {
    this.totalSize = totalSize;
    this.buffer = fromBuffer.asReadOnlyBuffer().order(order).asDoubleBuffer();
  }
