...
/**
 */
public class IntMetricColumnSerializer implements MetricColumnSerializer
{
  private final String metricName;
  private final IOPeon ioPeon;
  private final File outDir;

  private CompressedIntsSupplierSerializer writer;

  public IntMetricColumnSerializer(
      String metricName,
      File outDir,
      IOPeon ioPeon
  )
  ...
  {
    writer = CompressedIntsSupplierSerializer.create(
