...
{
  public static ComplexColumnSerializer create(String filenameBase, ObjectStrategy strategy)
  {
    return new ComplexColumnSerializer(filenameBase, strategy);
  }
  ...
  private ComplexColumnSerializer(String filenameBase, ObjectStrategy strategy)
  {
  ...
  {
    writer = new GenericIndexedWriter(String.format("%s.complex_column", filenameBase), strategy);
    writer.open();
  }
