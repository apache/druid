...
import org.apache.druid.segment.nested.ArrayFieldColumnWriter;
...
public class StandardNestedColumnSerializer extends StandardTypeColumnSerializer
{
  private static final Logger log = new Logger(StandardNestedColumnSerializer.class);
  ...
  public StandardNestedColumnSerializer(
      String name,
      IndexSpec indexSpec,
