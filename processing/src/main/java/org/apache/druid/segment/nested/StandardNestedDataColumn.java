...
public class StandardNestedDataColumn<TStringDictionary extends Indexed<ByteBuffer>>
    extends CompressedNestedDataComplexColumn<TStringDictionary>
{
  public StandardNestedDataColumn(
      String columnName,
  ...
  {
    return StandardTypeColumnSerializer.getInternalFileName(
        fileNameBase,
        StandardTypeColumnSerializer.NESTED_FIELD_PREFIX + fieldIndex
    );
  }
