...
public class ColumnPartSize
{
  ...
  public boolean equals(Object o)
  {
    ...
    ColumnPartSize that = (ColumnPartSize) o;
    return size == that.size && Objects.equals(description, that.description) && Objects.equals(
        components,
        that.components
    );
  }
  ...
  public int hashCode()
  {
    return Objects.hash(description, size, components);
  }
}
