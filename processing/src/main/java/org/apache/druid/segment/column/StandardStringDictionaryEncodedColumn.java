...
public class StandardStringDictionaryEncodedColumn<TIndexed extends Indexed<ByteBuffer>>
    implements DictionaryEncodedColumn<String>, StandardTypeColumn
{
  private final ColumnarInts column;
  private final TIndexed utf8Dictionary;

  public StandardStringDictionaryEncodedColumn(
  ...
  )
  {
        ...
        implements SingleValueHistoricalDimensionSelector, IdLookup, HistoricalDimensionSelector
    {
      ...
      public String lookupName(int id)
      {
        final String value = StandardStringDictionaryEncodedColumn.this.lookupName(id);
      ...
      public int lookupId(String name)
      {
        ...
        return StandardStringDictionaryEncodedColumn.this.lookupId(name);
      }
        ...
        if (extractionFn == null) {
          ...
          if (valueId >= 0) {
            return new ValueMatcher()
            {
              ...
              {
                inspector.visit("column", StandardStringDictionaryEncodedColumn.this);
              }
            };
          } else {
  ...
  public SingleValueDimensionVectorSelector makeSingleValueDimensionVectorSelector(final ReadableVectorOffset offset)
  {
    final class StringVectorSelector extends CachingStringDictionaryEncodedColumn.StringSingleValueDimensionVectorSelector
    {
      ...
      {
        return StandardStringDictionaryEncodedColumn.this.lookupName(id);
      }
