...
import org.apache.druid.segment.column.StandardStringDictionaryEncodedColumn;
...
public class StandardStringColumnSupplier implements Supplier<StandardTypeColumn>, ColumnIndexSupplier
{
  public static StandardStringColumnSupplier read(
      String columnName,
      ByteOrder byteOrder,
  ...
  )
  {
    ...
    if (version == StandardTypeColumnSerializer.V0) {
      try {
        ...
        return new StandardStringColumnSupplier(
            stringDictionary,
  ...
  private StandardStringColumnSupplier(
  ...
  public StandardTypeColumn get()
  {
    ...
    return new StandardStringDictionaryEncodedColumn<>(encodedColumnSupplier.get(), stringDictionary.singleThreaded());
  }
  ...
  ) throws IOException
  {
    return fileMapper.mapFile(
        StandardTypeColumnSerializer.getInternalFileName(filenameBase, internalFileName)
    );
  }
