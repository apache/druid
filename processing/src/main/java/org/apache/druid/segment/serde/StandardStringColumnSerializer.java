...
public class StandardStringColumnSerializer extends StandardTypeColumnSerializer
{
  private static final Logger log = new Logger(StandardStringColumnSerializer.class);
  ...
  public StandardStringColumnSerializer(
      String name,
      IndexSpec indexSpec,
  ...
  ) throws IOException
  {
    ...
    channel.write(ByteBuffer.wrap(new byte[]{StandardTypeColumnSerializer.V0}));
