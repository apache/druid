...
public class StandardTypeColumnHandler implements DimensionHandler<StructuredData, StructuredData, StructuredData>
{
  ...
  public StandardTypeColumnHandler(String name)
  {
    this.name = name;
  }
  ...
  {
    return new StandardTypeColumnMerger(name, indexSpec, segmentWriteOutMedium, progress, closer);
  }
