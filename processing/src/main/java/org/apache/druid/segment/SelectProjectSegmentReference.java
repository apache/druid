...
public class SelectProjectSegmentReference implements SegmentReference
{
  private static final Logger log = new Logger(FilterSegmentReference.class);
  private final VirtualColumns virtualColumns;
  private final SegmentReference baseSegment;

  public SelectProjectSegmentReference(SegmentReference segment, VirtualColumns vc)
  {
  ...
  {
    return new SelectProjectStorageAdapter(baseSegment.asStorageAdapter(), virtualColumns);
  }
