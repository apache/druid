...
public class StandardDoubleColumnSerializer extends StandardTypeColumnSerializer
{
  private static final Logger log = new Logger(StandardDoubleColumnSerializer.class);
  ...
  public StandardDoubleColumnSerializer(
      String name,
      IndexSpec indexSpec,
