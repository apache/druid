...
public class StandardArrayColumnSerializer extends StandardTypeColumnSerializer
{
  private static final Logger log = new Logger(StandardArrayColumnSerializer.class);
  ...
  public StandardArrayColumnSerializer(
      String name,
      IndexSpec indexSpec,
