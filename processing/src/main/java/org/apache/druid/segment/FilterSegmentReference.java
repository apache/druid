...
public class FilterSegmentReference implements SegmentReference
{
  private static final Logger log = new Logger(FilterSegmentReference.class);
  private final DimFilter filter;
  private final SegmentReference baseSegment;

  public FilterSegmentReference(SegmentReference segment, DimFilter filter)
  {
    this.filter = filter;
  ...
  {
    return new FilterStorageAdapter(baseSegment.asStorageAdapter(), filter);
  }
