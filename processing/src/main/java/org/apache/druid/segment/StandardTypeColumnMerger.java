...
import org.apache.druid.segment.serde.StandardArrayColumnSerializer;
import org.apache.druid.segment.serde.StandardDoubleColumnSerializer;
import org.apache.druid.segment.serde.StandardLongColumnSerializer;
import org.apache.druid.segment.serde.StandardNestedColumnSerializer;
import org.apache.druid.segment.serde.StandardStringColumnSerializer;
import org.apache.druid.segment.serde.StandardTypeColumnPartSerde;
...
/**
 * Column merger for {@link StandardTypeColumnIndexer} to eventually produce some form of
 * {@link org.apache.druid.segment.column.StandardTypeColumn}.
 * <p>
 * Depending on the types of values encountered
 */
public class StandardTypeColumnMerger implements DimensionMergerV9
{
  ...
  private StandardTypeColumnSerializer serializer;

  private ColumnType logicalType;

  public StandardTypeColumnMerger(
      String name,
      IndexSpec indexSpec,
  ...
  public void writeMergedValueDictionary(List<IndexableAdapter> adapters) throws IOException
  {
    try {
      ...
      for (int i = 0; i < adapters.size(); i++) {
        ...
        final SortedValueDictionary dimValues = closer.register(adapter.getSortedValueLookup(name, mergedFields));
      ...
      if (isSingleTypeRoot(mergedFields)) {
        ...
        switch (logicalType.getType()) {
          case LONG:
            final StandardLongColumnSerializer longSerializer = new StandardLongColumnSerializer(
                name,
                indexSpec,
            ...
            break;
          case DOUBLE:
            final StandardDoubleColumnSerializer doubleSerializer = new StandardDoubleColumnSerializer(
                name,
                indexSpec,
                segmentWriteOutMedium,
                progressIndicator,
            ...
            break;
          case STRING:
            final StandardStringColumnSerializer stringSerializer = new StandardStringColumnSerializer(
                name,
                indexSpec,
                segmentWriteOutMedium,
                progressIndicator,
            ...
            break;
          case ARRAY:
            final StandardArrayColumnSerializer arraySerializer = new StandardArrayColumnSerializer(
                name,
                indexSpec,
                segmentWriteOutMedium,
                progressIndicator,
        ...
        final StandardNestedColumnSerializer defaultSerializer = new StandardNestedColumnSerializer(
            name,
            indexSpec,
            segmentWriteOutMedium,
            progressIndicator,
  ...
  public ColumnDescriptor makeColumnDescriptor()
  {
    ...
    final StandardTypeColumnPartSerde partSerde = StandardTypeColumnPartSerde.serializerBuilder()
