...
public class StandardTypeColumnPartSerde implements ColumnPartSerde
{
  ...
  @JsonCreator
  public static StandardTypeColumnPartSerde createDeserializer(
  ...
  {
    return new StandardTypeColumnPartSerde(logicalType, hasNulls, byteOrder, bitmapSerdeFactory, null);
  }
  ...
  private StandardTypeColumnPartSerde(
  ...
  public Deserializer getDeserializer()
  {
    if (logicalType.is(ValueType.STRING)) {
      return ((columnName, buffer, builder, columnConfig) -> {
        StandardStringColumnSupplier supplier = StandardStringColumnSupplier.read(
            columnName,
            byteOrder,
            bitmapSerdeFactory,
            buffer,
        ...
        builder.setColumnFormat(new StandardTypeColumn.Format(logicalType, capabilitiesBuilder.hasNulls().isTrue()));
      });
    }
    ...
    if (logicalType.is(ValueType.DOUBLE)) {
      return ((columnName, buffer, builder, columnConfig) -> {
        StandardDoubleColumnSupplier supplier = StandardDoubleColumnSupplier.read(
            columnName,
            byteOrder,
            bitmapSerdeFactory,
            buffer,
    ...
    if (logicalType.isArray()) {
      return ((columnName, buffer, builder, columnConfig) -> {
        StandardArrayColumnSupplier supplier = StandardArrayColumnSupplier.read(
            columnName,
            logicalType,
            byteOrder,
            bitmapSerdeFactory,
    ...
    return (columnName, buffer, builder, columnConfig) -> {
      ...
      builder.setType(logicalType);
      builder.setStandardTypeColumnSupplier(supplier);
      builder.setColumnFormat(new StandardTypeColumn.Format(logicalType, hasNulls));
    };
  }
  ...
  public static class SerializerBuilder
  {
    ...
    public StandardTypeColumnPartSerde build()
    {
      return new StandardTypeColumnPartSerde(logicalType, hasNulls, byteOrder, bitmapSerdeFactory, serializer);
    }
  }
}
