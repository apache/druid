...
/**
 * SIMD specialization of {@code (long[], double[]) -> double[]} maximum. The op is hardcoded to
 * {@link DoubleVector#max} so the JIT statically resolves it to the platform's double-max intrinsic.
 */
public final class SimdLongDoubleMaxProcessor extends SimdLongDoubleProcessor
{
  public SimdLongDoubleMaxProcessor(
