...
/**
 * SIMD specialization of {@code (long[], long[]) -> long[]} minimum. The op is hardcoded to {@link LongVector#min}
 * so the JIT statically resolves it to the platform's long-min intrinsic.
 */
public final class SimdLongLongMinProcessor extends SimdLongLongProcessor
{
  public SimdLongLongMinProcessor(
