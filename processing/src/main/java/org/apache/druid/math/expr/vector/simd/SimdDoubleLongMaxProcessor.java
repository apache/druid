...
/**
 * SIMD specialization of {@code (double[], long[]) -> double[]} maximum. The op is hardcoded to
 * {@link DoubleVector#max} so the JIT statically resolves it to the platform's double-max intrinsic.
 */
public final class SimdDoubleLongMaxProcessor extends SimdDoubleLongProcessor
{
  public SimdDoubleLongMaxProcessor(
