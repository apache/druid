...
/**
 * SIMD specialization of {@code (double[], double[]) -> double[]} minimum. The op is hardcoded to
 * {@link DoubleVector#min} so the JIT statically resolves it to the platform's double-min intrinsic.
 */
public final class SimdDoubleDoubleMinProcessor extends SimdDoubleDoubleProcessor
{
  public SimdDoubleDoubleMinProcessor(
