...
/**
 * SIMD specialization of {@code (long[]) -> double[]} cube root. See {@link SimdSupportedUnaryOp#CBRT} for the
 * shared VO_MATHLIB performance notes.
 */
public final class SimdLongToDoubleCbrtProcessor extends SimdLongToDoubleUnaryProcessor
{
  public SimdLongToDoubleCbrtProcessor(ExprVectorProcessor<?> input, DoubleUnivariateLongFunction scalarFallback)
  {
