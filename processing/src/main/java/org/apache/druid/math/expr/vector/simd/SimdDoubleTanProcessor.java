...
/**
 * SIMD specialization of {@code (double[]) -> double[]} tangent. See {@link SimdSupportedUnaryOp#TAN} for the
 * shared VO_MATHLIB performance notes.
 */
public final class SimdDoubleTanProcessor extends SimdDoubleUnaryProcessor
{
  public SimdDoubleTanProcessor(ExprVectorProcessor<?> input, DoubleUnivariateDoubleFunction scalarFallback)
  {
