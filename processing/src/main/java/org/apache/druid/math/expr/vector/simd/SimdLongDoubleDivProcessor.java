...
/**
 * SIMD specialization of {@code (long[], double[]) -> double[]} division. The left long lane is widened to
 * {@link DoubleVector} via {@code castShape} before the hardcoded {@link DoubleVector#div} call.
 */
