...
/**
 * SIMD specialization of {@code (long[], long[]) -> long[]} maximum. The op is hardcoded to {@link LongVector#max}
 * so the JIT statically resolves it to the platform's long-max intrinsic.
 */
public final class SimdLongLongMaxProcessor extends SimdLongLongProcessor
{
  public SimdLongLongMaxProcessor(
