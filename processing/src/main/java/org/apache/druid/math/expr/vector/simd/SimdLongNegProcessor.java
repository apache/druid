...
/**
 * SIMD specialization of {@code (long[]) -> long[]} negation. The op is hardcoded to {@link LongVector#neg}
...
{
  public SimdLongNegProcessor(ExprVectorProcessor<?> input, LongUnivariateLongFunction scalarFallback)
  {
