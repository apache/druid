...
public class LongArrayFrameColumnReader implements FrameColumnReader
{
  ...
  public LongArrayFrameColumnReader(byte typeCode, ColumnType columnType, int columnNumber)
  {
  ...
  public Column readRACColumn(Frame frame)
  {
    ...
    validate(memory);
    return new ColumnAccessorBasedColumn(new LongArrayFrameColumn(frame, memory, columnType));
  }
  ...
  public ColumnPlus readColumn(Frame frame)
  {
    ...
    return new ColumnPlus(
        new LongArrayFrameColumn(frame, memory, columnType),
  ...
  private static class LongArrayFrameColumn extends ObjectColumnAccessorBase implements BaseColumn
  {
    ...
    private Object[] getNumericArray(final int physicalRow)
    {
      ...
      for (int i = 0; i < rowLength; ++i) {
        ...
        row[i] = getElementNullity(cumulativeIndex) ? null : getElement(cumulativeIndex);
      }
