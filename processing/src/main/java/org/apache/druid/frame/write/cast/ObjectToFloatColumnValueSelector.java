 ...
 * accessors based on that object value. The object is interpreted as a float.
 */
public class ObjectToFloatColumnValueSelector implements ColumnValueSelector<Float>
{
  ...
  public ObjectToFloatColumnValueSelector(
  ...
  private Float eval()
  {
    ...
    if (obj == null) {
      ...
      return eval.isNumericNull() ? null : (float) eval.asDouble();
    }
  }
}
