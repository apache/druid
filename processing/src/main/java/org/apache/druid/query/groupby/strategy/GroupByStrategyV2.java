...
public class GroupByStrategyV2 implements GroupByStrategy
{
  ...
  )
  {
    ...
    final String timestampResultField = query.getContextAsString(GroupByQuery.CTX_TIMESTAMP_RESULT_FIELD);
    ...
    if (hasTimestampResultField) {
      ...
      timestampResultFieldIndex = query.getContextAsInt(GroupByQuery.CTX_TIMESTAMP_RESULT_FIELD_INDEX);
