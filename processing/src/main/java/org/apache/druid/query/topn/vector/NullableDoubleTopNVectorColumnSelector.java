...
/**
 * {@link TopNVectorColumnSelector} for nullable DOUBLE columns.
 * Keys are encoded as a 1-byte null flag followed by an 8-byte double value.
 */
public class NullableDoubleTopNVectorColumnSelector implements TopNVectorColumnSelector
{
  private final VectorValueSelector selector;

  NullableDoubleTopNVectorColumnSelector(final VectorValueSelector selector)
  {
  ...
  public Object getDimensionValue(final MemoryPointer keyMemory, final int keyOffset)
  {
    ...
    return keyMemory.memory().getDouble(keyMemory.position() + keyOffset + 1);
  }
