...
/**
 * {@link TopNVectorColumnSelector} for nullable LONG columns.
 * Keys are encoded as a 1-byte null flag followed by an 8-byte long value.
 */
public class NullableLongTopNVectorColumnSelector implements TopNVectorColumnSelector
{
  private final VectorValueSelector selector;

  NullableLongTopNVectorColumnSelector(final VectorValueSelector selector)
  {
  ...
  public Object getDimensionValue(final MemoryPointer keyMemory, final int keyOffset)
  {
    ...
    return keyMemory.memory().getLong(keyMemory.position() + keyOffset + 1);
  }
