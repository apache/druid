...
public class QueryContexts
{
  ...
  public static final String SEGMENT_PRUNING_KEY = "segmentPruning";
  ...
  public static final boolean DEFAULT_SEGMENT_PRUNING = true;
  ...
  public static <T> boolean isSegmentPruningEnabled(Query<T> query)
  {
    return parseBoolean(query, SEGMENT_PRUNING_KEY, DEFAULT_SEGMENT_PRUNING);
  }
