...
import org.apache.druid.collections.TreeMultisetBasedMulticolumnSorter;
...
public class TreeMultisetBasedSorterSequence extends BaseSequence<ScanResultValue, Iterator<ScanResultValue>>
{
  public TreeMultisetBasedSorterSequence(IteratorMaker<ScanResultValue, Iterator<ScanResultValue>> maker)
  {
    super(maker);
  }

  static class TreeMultisetBasedSorterIteratorMaker
      implements BaseSequence.IteratorMaker<ScanResultValue, Iterator<ScanResultValue>>
  {
    ...
    public TreeMultisetBasedSorterIteratorMaker(
    ...
    public Iterator<ScanResultValue> make()
    {
      ...
      )
      {
        ...
        {
          return new TreeMultisetBasedMulticolumnSorter<List<Object>>(rowsToCompactedListComparator());
        }

        @Override
        MultiColumnSorter<Map<String, Object>> rowsToListMulticolumnSorter()
        {
          return new TreeMultisetBasedMulticolumnSorter<Map<String, Object>>(rowsToListComparator());
        }
      };
    }
