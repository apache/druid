...
/**
 * {@link TopNVectorColumnSelector} for non-nullable LONG columns.
 * Keys are encoded as 8-byte longs in the shared key space.
 */
public class LongTopNVectorColumnSelector implements TopNVectorColumnSelector
{
  private final VectorValueSelector selector;

  LongTopNVectorColumnSelector(final VectorValueSelector selector)
  {
  ...
  {
    return keyMemory.memory().getLong(keyMemory.position() + keyOffset);
  }
