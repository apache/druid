...
public class TreeSetBasedSorterSequence extends BaseSequence<ScanResultValue, Iterator<ScanResultValue>>
{
  public TreeSetBasedSorterSequence(IteratorMaker<ScanResultValue, Iterator<ScanResultValue>> maker)
  {
    super(maker);
  }

  static class TreeSetBasedSorterIteratorMaker
      implements BaseSequence.IteratorMaker<ScanResultValue, Iterator<ScanResultValue>>
  {
    ...
    public TreeSetBasedSorterIteratorMaker(
