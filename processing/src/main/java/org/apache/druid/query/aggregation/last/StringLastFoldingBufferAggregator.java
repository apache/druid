...
public class StringLastFoldingBufferAggregator implements BufferAggregator
{
  ...
  public StringLastFoldingBufferAggregator(
      BaseObjectColumnValueSelector<SerializablePairLongString> valueSelector,
      int maxStringBytes
  )
  {
  ...
  public void aggregate(ByteBuffer buf, int position)
  {
    ...
    if (inPair != null) {
      ...
      if (inPair.lhs >= lastTime) {
        StringFirstLastUtils.writePair(buf, position, inPair, maxStringBytes);
      }
    }
  }
