...
public class StringFirstAggregatorFactory extends AggregatorFactory
{
  ...
  public Aggregator factorize(ColumnSelectorFactory metricFactory)
  {
    if (foldColumn != null) {
      ...
      if (selector instanceof NilColumnValueSelector) {
        ...
        return new StringFirstFoldingAggregator(selector, maxStringBytes);
      }
    }
  ...
  public BufferAggregator factorizeBuffered(ColumnSelectorFactory metricFactory)
  {
    if (foldColumn != null) {
      ...
      if (selector instanceof NilColumnValueSelector) {
        ...
        return new StringFirstFoldingBufferAggregator(selector, maxStringBytes);
      }
    }
  ...
  public static class Builder
  {
    ...
    public Builder(StringFirstAggregatorFactory factory)
    {
    ...
    public StringFirstAggregatorFactory build()
    {
      return new StringFirstAggregatorFactory(name, fieldName, timeColumn, foldColumn, maxStringBytes, finalize);
    }
  }
}
