  ...
  public RowSignature resultArraySignature(TimeBoundaryQuery query)
  {
    if (query.isMinTime() || query.isMaxTime()) {
      ...
      String outputName = query.isMinTime() ?
                          query.getContextAsString(TimeBoundaryQuery.MIN_TIME_ARRAY_OUTPUT_NAME, TimeBoundaryQuery.MIN_TIME) :
                          query.getContextAsString(TimeBoundaryQuery.MAX_TIME_ARRAY_OUTPUT_NAME, TimeBoundaryQuery.MAX_TIME);
