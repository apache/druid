...
public class StringLastFoldingAggregator implements Aggregator
{
  ...
  public StringLastFoldingAggregator(
      final BaseObjectColumnValueSelector<SerializablePairLongString> valueSelector,
