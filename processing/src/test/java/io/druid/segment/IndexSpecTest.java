...
public class IndexSpecTest
{
  ...
  public void testSerde() throws Exception
  {
    ...
    Assert.assertEquals(CompressionFactory.LongEncodingFormat.DELTA, spec.getMetricLongEncodingFormat());
  ...
  public void testDefaults() throws Exception
  {
    ...
    Assert.assertEquals(CompressionFactory.LongEncodingFormat.LONGS, spec.getMetricLongEncodingFormat());
  }
}
