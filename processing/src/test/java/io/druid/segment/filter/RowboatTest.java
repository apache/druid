...
public class RowboatTest
{
  ...
  public void testRowboatCompare()
  {
    ...
    Rowboat rb1 = new Rowboat(12345L, new Comparable[][]{new Comparable[]{1}, new Comparable[]{2}}, new Object[]{new Integer(7)}, 5, handlers);
    Rowboat rb2 = new Rowboat(12345L, new Comparable[][]{new Comparable[]{1}, new Comparable[]{2}}, new Object[]{new Integer(7)}, 5, handlers);
    Assert.assertEquals(0, rb1.compareTo(rb2));

    Rowboat rb3 = new Rowboat(12345L, new Comparable[][]{new Comparable[]{3}, new Comparable[]{2}}, new Object[]{new Integer(7)}, 5, handlers);
  ...
  public void testToString()
  {
    ...
    Assert.assertEquals(
        ...
        new Rowboat(0, new Comparable[][]{new Comparable[]{1}, new Comparable[]{2}}, new Object[]{"someMetric"}, 5, handlers).toString()
    );
  }
