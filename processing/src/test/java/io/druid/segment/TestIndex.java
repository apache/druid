...
public class TestIndex
{
  ...
  public static final DimensionSchema[] DIMENSION_SCHEMAS = new DimensionSchema[]{
      new StringDimensionSchema("market"),
      new LongDimensionSchema("market_long"),
      new FloatDimensionSchema("market_float"),
      new StringDimensionSchema("quality"),
      new LongDimensionSchema("quality_long"),
      new FloatDimensionSchema("quality_float"),
  ...
  {
    final DimensionsSpec dimSpec = new DimensionsSpec(Arrays.asList(DIMENSION_SCHEMAS), null, null);
