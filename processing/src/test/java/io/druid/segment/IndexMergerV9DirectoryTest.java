...
import io.druid.segment.store.MMapDirectory;
...
public class IndexMergerV9DirectoryTest
{
  @Rule
  ...
  public IndexMergerV9DirectoryTest(
      boolean useV9,
      BitmapSerdeFactory bitmapSerdeFactory,
      CompressedObjectStrategy.CompressionStrategy compressionStrategy,
      CompressedObjectStrategy.CompressionStrategy dimCompressionStrategy,
  ...
  private Directory createTmpMMapDirectory() throws IOException
  {
    final File tempDir = temporaryFolder.newFolder();
    Path dirPath = tempDir.toPath();
    Directory directory = new MMapDirectory(dirPath);
    return directory;
  }
  ...
  public void testPersist() throws Exception
  {
    ...
    //v9
    IndexMerger v9IndexMerger = TestHelper.getTestIndexMergerV9();

    Directory mmapDirectory = createTmpMMapDirectory();
    INDEX_MERGER.persistV1(toPersist, mmapDirectory, indexSpec);
    QueryableIndex index = closer.closeLater(INDEX_IO.loadIndex(mmapDirectory));
  ...
  public void testPersistWithDifferentDims() throws Exception
  {
    ...
    Directory directory = createTmpMMapDirectory();
    INDEX_MERGER.persistV1(
        toPersist,
        directory,
        indexSpec
    );
  ...
  public void testPersistMerge() throws Exception
  {
    ...
    Directory dir1 = createTmpMMapDirectory();
    Directory dir2 = createTmpMMapDirectory();
    Directory mergedDir = createTmpMMapDirectory();
    ...
    INDEX_MERGER.mergeQueryableIndexV1(
  ...
  public void testPersistEmptyColumn() throws Exception
  {
    ...
    Directory dir1 = createTmpMMapDirectory();
    Directory dir2 = createTmpMMapDirectory();
    Directory dir3 = createTmpMMapDirectory();
  ...
  public void testMergeRetainsValues() throws Exception
  {
    ...
    Directory directory1 = createTmpMMapDirectory();
    Directory mergedDir = createTmpMMapDirectory();
    ...
    INDEX_IO.validateTwoSegments(directory1, mergedDir);
  ...
  public void testAppendRetainsValues() throws Exception
  {
    ...
    INDEX_MERGER.appendV1(
        ImmutableList.<IndexableAdapter>of(incrementalAdapter), null, directory1, indexSpec
    );
    QueryableIndex index1 = closer.closeLater(
        INDEX_IO.loadIndex(
            directory1
  ...
  public void testConvertSame() throws Exception
  {
    ...
    Directory directory1 = createTmpMMapDirectory();
    Directory convertDir = createTmpMMapDirectory();
    ...
    INDEX_MERGER.persistV1(toPersist1, directory1, indexSpec);
    QueryableIndex index1 = closer.closeLater(
        INDEX_IO.loadIndex(directory1)
    );
    ...
    INDEX_IO.validateTwoSegments(directory1, convertDir);
  ...
  public void testNonLexicographicDimOrderMerge() throws Exception
  {
    ...
    Directory tmpDir = createTmpMMapDirectory();
    Directory tmpDir2 = createTmpMMapDirectory();
    Directory tmpDir3 = createTmpMMapDirectory();
    Directory tmpDirMerged = createTmpMMapDirectory();
  ...
  public void testDisjointDimMerge() throws Exception
  {
    ...
    Directory tmpDirA = createTmpMMapDirectory();
    Directory tmpDirB = createTmpMMapDirectory();
    Directory tmpDirB2 = createTmpMMapDirectory();
    Directory tmpDirMerged = createTmpMMapDirectory();
  ...
  public void testMergeWithSupersetOrdering() throws Exception
  {
    ...
    Directory tmpDirA = createTmpMMapDirectory();
    Directory tmpDirB = createTmpMMapDirectory();
    Directory tmpDirBA = createTmpMMapDirectory();
    Directory tmpDirBA2 = createTmpMMapDirectory();
    Directory tmpDirC = createTmpMMapDirectory();
    Directory tmpDirMerged = createTmpMMapDirectory();
    Directory tmpDirMerged2 = createTmpMMapDirectory();
  ...
  public void testPersistNullColumnSkipping() throws Exception
  {
    ...
    Directory tempDir = createTmpMMapDirectory();
    INDEX_MERGER.persistV1(
        index1,
        tempDir,
        indexSpec
  ...
  public void testCloser() throws Exception
  {
    ...
    try {
      ...
      if(DirectoryUtils.hasFileStartWith(tempDir, "filePeon")){
        Assert.fail("filePeon* files not clean.");
      }
      if(DirectoryUtils.hasFileEndWith(tempDir, "drd")){
        Assert.fail("*.drd files not clean.");
      }
