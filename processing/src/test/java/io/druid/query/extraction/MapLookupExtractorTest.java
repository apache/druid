...
public class MapLookupExtractorTest
{
  ...
  public void testGetCacheKey() throws Exception
  {
    ...
    final MapLookupExtractor fn3 = new MapLookupExtractor(ImmutableMap.<Object, String>of("foo2", "bar"), false);
    Assert.assertFalse(Arrays.equals(fn.getCacheKey(), fn3.getCacheKey()));
    final MapLookupExtractor fn4 = new MapLookupExtractor(ImmutableMap.<Object, String>of("foo", "bar2"), false);
