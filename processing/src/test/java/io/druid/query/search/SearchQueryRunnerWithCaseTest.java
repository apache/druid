...
public class SearchQueryRunnerWithCaseTest
{
  ...
  public static Iterable<Object[]> constructorFeeder() throws IOException
  {
    ...
    return transformToConstructionFeeder(
        Arrays.asList(
            makeQueryRunner(factory, "index1", new IncrementalIndexSegment(index1, "index1"), "incremental1"),
            makeQueryRunner(factory, "index2", new IncrementalIndexSegment(index2, "index2"), "incremental2"),
            makeQueryRunner(factory, "index3", new QueryableIndexSegment("index3", index3), "mmaped1"),
            makeQueryRunner(factory, "index4", new QueryableIndexSegment("index4", index4), "mmaped2")
        )
    );
  }
