...
/**
 */
public class DoubleSumAggregationTest
{
  @Rule
  ...
  {
    String line1 = "2011-01-12T00:00:00.000Z\tproduct1\t2.1";
    String line2 = "2011-01-14T00:00:00.000Z\tproduct2\t3.2";
  ...
  public void testIngestAndQueryNullExponent() throws Exception
  {
    ...
    Assert.assertEquals(26.5, row.getFloatMetric("quantity"), 0.001);
  }
  ...
  public void testIngestAndQuerySquareExponent() throws Exception
  {
    ...
    MapBasedRow row = (MapBasedRow) Sequences.toList(seq, Lists.newArrayList()).get(0);
    Assert.assertEquals(73.25, row.getFloatMetric("quantity"), 0.001);
  }
}
