...
public class SelectQueryRunnerTest
{
  ...
  public void testFullOnSelect()
  {
    ...
    List<Result<SelectResultValue>> expectedResults = toExpected(
        ...
        Lists.<String>newArrayList("index", "quality_uniques", "indexMin", "indexMaxPlusTen"),
        offset.startOffset(),
        offset.threshold()
    );
                ...
                Arrays.asList(
                    new EventHolder(
                        ...
                        new ImmutableMap.Builder<String, Object>()
                            ...
                            .put("indexMin", 100.000000F)
                            .put("indexMaxPlusTen", 110.000000F)
                            .build()
                    ),
                    new EventHolder(
                        QueryRunnerTestHelper.segmentId,
                ...
                Arrays.asList(
                    new EventHolder(
                        ...
                        new ImmutableMap.Builder<String, Object>()
                            ...
                            .put("indexMin", 780.27197265625F)
                            .put("indexMaxPlusTen", 790.27197265625F)
                            .build()
                    ),
                    new EventHolder(
                        QueryRunnerTestHelper.segmentId,
                        ...
                        new ImmutableMap.Builder<String, Object>()
                            ...
                            .put("indexMin", 962.731201171875F)
                            .put("indexMaxPlusTen", 972.731201171875F)
                            .build()
                    ),
                    new EventHolder(
                        QueryRunnerTestHelper.segmentId,
