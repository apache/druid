...
public class MultiSegmentSelectQueryTest
{
  ...
  public static void setup() throws IOException
  {
    ...
    timeline.add(index0.getInterval(), "v1", new SingleElementPartitionChunk(segment0), -1);
    timeline.add(index1.getInterval(), "v1", new SingleElementPartitionChunk(segment1), -1);
    timeline.add(index2.getInterval(), "v2", new SingleElementPartitionChunk(segment_override), -1);
