...
public class PropUtilsTest
{
  ...
  public void testNotSpecifiedGetProperty()
  {
    ...
    Assertions.assertThrows(ISE.class, () -> PropUtils.getProperty(prop, ""));
  }
  ...
  {
    Properties prop = new Properties();
    Assertions.assertThrows(ISE.class, () -> PropUtils.getPropertyAsInt(prop, "", null));
  }
  ...
  public void testFormatExceptionGetPropertyAsInt()
  {
    ...
    Assertions.assertThrows(ISE.class, () -> PropUtils.getPropertyAsInt(prop, "key", null));
  }
}
