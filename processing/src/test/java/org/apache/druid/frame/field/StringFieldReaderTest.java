...
public class StringFieldReaderTest extends InitializedNullHandlingTest
{
  ...
  public void test_isNull_nullValue()
  {
    ...
    Assert.assertTrue(new StringFieldReader(false, FieldReader.ILLEGAL_FIELD_NUMBER, FieldReader.ILLEGAL_FIELD_COUNT).isNull(memory, MEMORY_POSITION));
    Assert.assertFalse(new StringFieldReader(true, FieldReader.ILLEGAL_FIELD_NUMBER, FieldReader.ILLEGAL_FIELD_COUNT).isNull(memory, MEMORY_POSITION));
  }
  ...
  public void test_isNull_twoNullValues()
  {
    ...
    Assert.assertFalse(new StringFieldReader(false, FieldReader.ILLEGAL_FIELD_NUMBER, FieldReader.ILLEGAL_FIELD_COUNT).isNull(memory, MEMORY_POSITION));
    Assert.assertFalse(new StringFieldReader(true, FieldReader.ILLEGAL_FIELD_NUMBER, FieldReader.ILLEGAL_FIELD_COUNT).isNull(memory, MEMORY_POSITION));
  }
  ...
  public void test_isNull_nullRow()
  {
    writeToMemory(null);
    Assert.assertTrue(new StringFieldReader(false, FieldReader.ILLEGAL_FIELD_NUMBER, FieldReader.ILLEGAL_FIELD_COUNT).isNull(memory, MEMORY_POSITION));
    Assert.assertTrue(new StringFieldReader(true, FieldReader.ILLEGAL_FIELD_NUMBER, FieldReader.ILLEGAL_FIELD_COUNT).isNull(memory, MEMORY_POSITION));
  }
  ...
  public void test_isNull_emptyString()
  {
    ...
    Assert.assertEquals(
        ...
        new StringFieldReader(false, FieldReader.ILLEGAL_FIELD_NUMBER, FieldReader.ILLEGAL_FIELD_COUNT).isNull(memory, MEMORY_POSITION)
    );
    Assert.assertFalse(new StringFieldReader(true, FieldReader.ILLEGAL_FIELD_NUMBER, FieldReader.ILLEGAL_FIELD_COUNT).isNull(memory, MEMORY_POSITION));
  }
  ...
  public void test_makeColumnValueSelector_singleString_notArray()
  {
    ...
    final ColumnValueSelector<?> readSelector =
        new StringFieldReader(false, FieldReader.ILLEGAL_FIELD_NUMBER, FieldReader.ILLEGAL_FIELD_COUNT).makeColumnValueSelector(memory, new ConstantFieldPointer(MEMORY_POSITION));
    final ColumnValueSelector<?> readSelectorAsArray =
        new StringFieldReader(true, FieldReader.ILLEGAL_FIELD_NUMBER, FieldReader.ILLEGAL_FIELD_COUNT).makeColumnValueSelector(memory, new ConstantFieldPointer(MEMORY_POSITION));
  ...
  public void test_makeDimensionSelector_multiString_asArray()
  {
    ...
    final IllegalStateException e = Assert.assertThrows(
        ...
        () -> new StringFieldReader(true, FieldReader.ILLEGAL_FIELD_NUMBER, FieldReader.ILLEGAL_FIELD_COUNT).makeDimensionSelector(memory, new ConstantFieldPointer(MEMORY_POSITION), null)
    );
  ...
  public void test_makeDimensionSelector_multiString()
  {
    ...
    final DimensionSelector readSelector =
        new StringFieldReader(false, FieldReader.ILLEGAL_FIELD_NUMBER, FieldReader.ILLEGAL_FIELD_COUNT).makeDimensionSelector(memory, new ConstantFieldPointer(MEMORY_POSITION), null);
  ...
  public void test_makeDimensionSelector_multiString_withExtractionFn()
  {
    ...
    final DimensionSelector readSelector =
        new StringFieldReader(false, FieldReader.ILLEGAL_FIELD_NUMBER, FieldReader.ILLEGAL_FIELD_COUNT).makeDimensionSelector(
            memory,
