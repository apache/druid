...
public class DoubleFieldReaderTest extends InitializedNullHandlingTest
{
  ...
  public void setUp()
  {
    ...
    fieldWriter = new DoubleFieldWriter(writeSelector, false);
  }
  ...
  public void test_isNull_defaultOrNull()
  {
    ...
    Assert.assertEquals(NullHandling.sqlCompatible(), new DoubleFieldReader(false).isNull(memory, MEMORY_POSITION));
  }
  ...
  {
    writeToMemory(5.1d);
    Assert.assertFalse(new DoubleFieldReader(false).isNull(memory, MEMORY_POSITION));
  }
  ...
  public void test_makeColumnValueSelector_defaultOrNull()
  {
    ...
    final ColumnValueSelector<?> readSelector =
        new DoubleFieldReader(false).makeColumnValueSelector(memory, new ConstantFieldPointer(MEMORY_POSITION));
  ...
  public void test_makeDimensionSelector_defaultOrNull()
  {
    ...
    final DimensionSelector readSelector =
        new DoubleFieldReader(false).makeDimensionSelector(memory, new ConstantFieldPointer(MEMORY_POSITION), null);
  ...
  public void test_makeDimensionSelector_aValue_extractionFn()
  {
    ...
    final DimensionSelector readSelector =
        new DoubleFieldReader(false).makeDimensionSelector(
            memory,
