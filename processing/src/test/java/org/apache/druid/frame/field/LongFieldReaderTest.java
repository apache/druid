...
public class LongFieldReaderTest extends InitializedNullHandlingTest
{
  ...
  public void setUp()
  {
    ...
    fieldWriter = new LongFieldWriter(writeSelector, false);
  }
  ...
  public void test_isNull_defaultOrNull()
  {
    ...
    Assert.assertEquals(NullHandling.sqlCompatible(), new LongFieldReader(false).isNull(memory, MEMORY_POSITION));
  }
  ...
  {
    writeToMemory(5L);
    Assert.assertFalse(new LongFieldReader(false).isNull(memory, MEMORY_POSITION));
  }
  ...
  public void test_makeDimensionSelector_defaultOrNull()
  {
    ...
    final DimensionSelector readSelector =
        new LongFieldReader(false).makeDimensionSelector(memory, new ConstantFieldPointer(MEMORY_POSITION), null);
  ...
  public void test_makeDimensionSelector_aValue_extractionFn()
  {
    ...
    final DimensionSelector readSelector =
        new LongFieldReader(false).makeDimensionSelector(
            memory,
