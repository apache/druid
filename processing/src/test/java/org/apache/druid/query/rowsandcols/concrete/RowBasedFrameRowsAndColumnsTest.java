...
public class RowBasedFrameRowsAndColumnsTest extends RowsAndColumnsTestBase
{
  ...
  public static Function<MapOfColumnsRowsAndColumns, RowBasedFrameRowsAndColumns> MAKER = input -> buildFrame(input);

  private static RowBasedFrameRowsAndColumns buildFrame(MapOfColumnsRowsAndColumns input)
  {
    ...
    return (RowBasedFrameRowsAndColumns) rac.getBase();
  }
}
