...
public class GroupByStatsProviderTest
{
  ...
  public void testMetricCollection()
  {
    ...
    stats2.mergeBufferTotalUsage(100);
    ...
    Assert.assertEquals(0L, aggregateStats.getMaxMergeBufferUsage());
    ...
    Assert.assertEquals(100L, aggregateStats.getMaxMergeBufferUsage()); 
  ...
  @Test
  public void testMaxMetricsWithVaryingMaxPerMetric()
  {
    GroupByStatsProvider statsProvider = new GroupByStatsProvider();
    ...
    stats2.mergeBufferTotalUsage(500);
    ...
    stats3.mergeBufferTotalUsage(100);
    ...
    stats4.mergeBufferTotalUsage(75);
    ...
    Assert.assertEquals(500L, aggregateStats.getMaxMergeBufferUsage()); 
    ...
    Assert.assertEquals(725L, aggregateStats.getMergeBufferTotalUsage()); 
