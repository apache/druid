...
public class FramedOnHeapAggregatableTest extends SemanticTestBase
{
  ...
  public void testWindowedAggregationWindowSmallerThanRowsNoOffsets()
  {
    ...
    final RowsAndColumns results = agger.aggregateAll(
        WindowFrame.PeerType.ROWScreate(false, 0, false, 0, null),
  ...
  public void testWindowedAggregationWindowSmallerThanRows()
  {
    ...
    final RowsAndColumns results = agger.aggregateAll(
        WindowFrame.PeerType.ROWScreate(false, 1, false, 2, null),
        new AggregatorFactory[]{
            new LongSumAggregatorFactory("sumFromLong", "intCol"),
            new DoubleMaxAggregatorFactory("maxFromInt", "intCol"),
            }
  ...
  public void testWindowedAggregationWindowSmallerThanRowsOnlyUpper()
  {
    ...
    final RowsAndColumns results = agger.aggregateAll(
        WindowFrame.PeerType.ROWScreate(false, 0, false, 2, null),
        new AggregatorFactory[]{
            new LongSumAggregatorFactory("sumFromLong", "intCol"),
            new DoubleMaxAggregatorFactory("maxFromInt", "intCol"),
            }
  ...
  public void testWindowedAggregationWindowSmallerThanRowsOnlyLower()
  {
    ...
    final RowsAndColumns results = agger.aggregateAll(
        WindowFrame.PeerType.ROWScreate(false, 2, false, 0, null),
        new AggregatorFactory[]{
            new LongSumAggregatorFactory("sumFromLong", "intCol"),
            new DoubleMaxAggregatorFactory("maxFromInt", "intCol"),
            }
  ...
  public void testWindowedAggregationWindowLargerThanRows()
  {
    ...
    final RowsAndColumns results = agger.aggregateAll(
        WindowFrame.PeerType.ROWScreate(false, 5, false, 7, null),
        new AggregatorFactory[]{
            new LongSumAggregatorFactory("sumFromLong", "intCol"),
            new DoubleMaxAggregatorFactory("maxFromInt", "intCol"),
  ...
  public void testWindowedAggregationLowerLargerThanRows()
  {
    ...
    final RowsAndColumns results = agger.aggregateAll(
        WindowFrame.PeerType.ROWScreate(false, 5, false, 1, null),
        new AggregatorFactory[]{
            new LongSumAggregatorFactory("sumFromLong", "intCol"),
            new DoubleMaxAggregatorFactory("maxFromInt", "intCol"),
            new LongMinAggregatorFactory("longMin", "intCol"),
  ...
  public void testWindowedAggregationLowerLargerThanRowsNoUpper()
  {
    ...
    final RowsAndColumns results = agger.aggregateAll(
        WindowFrame.PeerType.ROWScreate(false, 5, false, 0, null),
        new AggregatorFactory[]{
            new LongSumAggregatorFactory("sumFromLong", "intCol"),
            new DoubleMaxAggregatorFactory("maxFromInt", "intCol"),
            new LongMinAggregatorFactory("longMin", "intCol"),
  ...
  public void testWindowedAggregationUpperLargerThanRows()
  {
    ...
    final RowsAndColumns results = agger.aggregateAll(
        WindowFrame.PeerType.ROWScreate(false, 1, false, 7, null),
        new AggregatorFactory[]{
            new LongSumAggregatorFactory("sumFromLong", "intCol"),
            new DoubleMaxAggregatorFactory("maxFromInt", "intCol"),
            new LongMinAggregatorFactory("longMin", "intCol"),
  ...
  public void testWindowedAggregationUpperLargerThanRowsNoLower()
  {
    ...
    final RowsAndColumns results = agger.aggregateAll(
        WindowFrame.PeerType.ROWScreate(false, 0, false, 7, null),
        new AggregatorFactory[]{
            new LongSumAggregatorFactory("sumFromLong", "intCol"),
            new DoubleMaxAggregatorFactory("maxFromInt", "intCol"),
            new LongMinAggregatorFactory("longMin", "intCol"),
  ...
  public void testUnboundedWindowedAggregation()
  {
    ...
    final RowsAndColumns results = agger.aggregateAll(
        WindowFrame.PeerType.ROWScreate(true, 0, true, 0, null),
        new AggregatorFactory[]{
            new LongSumAggregatorFactory("sumFromLong", "intCol"),
  ...
  public void testCumulativeAggregation()
  {
    ...
    final RowsAndColumns results = agger.aggregateAll(
        WindowFrame.PeerType.ROWScreate(true, 0, false, 0, null),
        new AggregatorFactory[]{
  ...
  public void testReverseCumulativeAggregation()
  {
    ...
    final RowsAndColumns results = agger.aggregateAll(
        WindowFrame.PeerType.ROWScreate(false, 0, true, 0, null),
        new AggregatorFactory[]{
            new LongMaxAggregatorFactory("cummMax", "intCol"),
            new DoubleSumAggregatorFactory("cummSum", "doubleCol")
        }
  ...
  {
    WindowFrame frame = PeerType.RANGEcreate(false, 1, false, 0, Collections.singletonList(ColumnWithDirection.ascending("c1")));
  ...
  {
    WindowFrame frame = PeerType.RANGEcreate(false, 0, false, 1, Collections.singletonList(ColumnWithDirection.ascending("c1")));
  ...
  {
    WindowFrame frame = PeerType.RANGEcreate(false, 1, false, 1, Collections.singletonList(ColumnWithDirection.ascending("c1")));
  ...
  {
    WindowFrame frame = PeerType.RANGEcreate(false, 1, false, 2, Collections.singletonList(ColumnWithDirection.ascending("c1")));
