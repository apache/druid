...
public class SearchSortSpecTest
{
  ...
  public void testLexicographicComparator()
  {
    ...
    Assertions.assertTrue(spec.getComparator().compare(hit2, hit3) == 0);
    Assertions.assertTrue(spec.getComparator().compare(hit2, hit1) > 0);
    Assertions.assertTrue(spec.getComparator().compare(hit1, hit3) < 0);
  }
  ...
  public void testAlphanumericComparator()
  {
    ...
    Assertions.assertTrue(spec.getComparator().compare(hit1, hit2) > 0);
    Assertions.assertTrue(spec.getComparator().compare(hit3, hit1) > 0);
    Assertions.assertTrue(spec.getComparator().compare(hit3, hit2) > 0);
  }
  ...
  public void testNumericComparator()
  {
    ...
    Assertions.assertTrue(spec.getComparator().compare(hit1, hit4) > 0);
  }
  ...
  public void testStrlenComparator()
  {
    ...
    Assertions.assertTrue(spec.getComparator().compare(hit1, hit1) == 0);
  }
  ...
  public void testSerde() throws IOException
  {
    ...
    Assertions.assertEquals(spec, jsonMapper.readValue(jsonSpec, SearchSortSpec.class));

    String expectJsonSpec2 = "{\"type\":\"alphanumeric\"}";
    Assertions.assertEquals(spec, jsonMapper.readValue(expectJsonSpec2, SearchSortSpec.class));
  }
}
