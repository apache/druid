...
public class NestedDataScanQueryTest extends InitializedNullHandlingTest
{
  ...
  @Test
  public void testIngestAndScanSegmentsRealtimeSchemaDiscoveryTypeGauntletOptimizedConstants() throws Exception
  {
    ...
    List<Segment> segs = NestedDataTestUtils.createSegments(
        ...
        Granularities.NONE,
        true,
        IndexSpec.builder().optimizeJsonConstantColumns(true).build()
    );
