...
public class ClockDriftSafeMonitorSchedulerTest
{
  ...
  public void testFindMonitor()
  {
    ...
    JupiterAssertions.assertTrue(maybeFound1.isPresent());
    JupiterAssertions.assertTrue(maybeFound2.isPresent());
    JupiterAssertions.assertSame(monitor1, maybeFound1.get());
    JupiterAssertions.assertSame(monitor2, maybeFound2.get());

    JupiterAssertions.assertFalse(scheduler.findMonitor(Monitor3.class).isPresent());
  }
  ...
  public void testStart_UnexpectedExceptionWhileMonitoring() throws InterruptedException
  {
    ...
    JupiterAssertions.assertTrue(monitorResultHolder.get());
    scheduler.stop();
  }
