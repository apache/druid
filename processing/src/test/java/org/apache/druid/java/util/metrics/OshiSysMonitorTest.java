...
public class OshiSysMonitorTest
{
  ...
  public void testMemStats()
  {
    ...
    m.stop();
    Assertions.assertEquals(3, emitter.getNumEmittedEvents());
  ...
  public void testNetStats()
  {
    ...
    m.monitorNetStats(emitter);
    Assertions.assertEquals(16, emitter.getNumEmittedEvents()); // 8 * 2 whitelisted ips
  ...
  public void testCpuStats()
  {
    ...
    m.monitorCpuStats(emitter);
    m.stop();
    Assertions.assertEquals(16, emitter.getNumEmittedEvents()); // 8 ticktype * 2 processors
