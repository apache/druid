...
public abstract class BaseFilterTest extends InitializedNullHandlingTest
{
  ...
  static final VirtualColumns VIRTUAL_COLUMNS = VirtualColumns.create(
      ImmutableList.of(
          ...
          new ExpressionVirtualColumn("vd0", "d0 + (d0 - d0)", ColumnType.DOUBLE, TestExprMacroTable.INSTANCE),
          new ExpressionVirtualColumn("vf0", "f0 + (f0 - f0)", ColumnType.FLOAT, TestExprMacroTable.INSTANCE),
          new ExpressionVirtualColumn("vl0", "l0 + (l0 - l0)", ColumnType.LONG, TestExprMacroTable.INSTANCE),
