...
public class FilterStorageAdapterTest extends InitializedNullHandlingTest
{
  ...
  private static FilterStorageAdapter UNNEST_STORAGE_ADAPTER;
  private static FilterStorageAdapter UNNEST_STORAGE_ADAPTER1;
  ...
  public static void setup()
  {
    ...
    UNNEST_STORAGE_ADAPTER = new FilterStorageAdapter(
        INCREMENTAL_INDEX_STORAGE_ADAPTER,
        null
    );

    UNNEST_STORAGE_ADAPTER1 = new FilterStorageAdapter(
  ...
  public void test_group_of_unnest_adapters_column_capabilities()
  {
    ...
    FilterStorageAdapter adapter = UNNEST_STORAGE_ADAPTER;
