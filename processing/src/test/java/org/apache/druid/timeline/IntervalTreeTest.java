...
public class IntervalTreeTest
{
    ...
    public void testSize()
    {
        ...
        Assert.assertEquals( "Size", 4, tree.size());
    }
    ...
    {
        IntervalTree<String> tree = setupBaseIntervalTree();
        Map<Interval, String> entries = tree.findEncompassing(Intervals.of("2025-01-05T00:00:00/P1D"));
    ...
    public void testOverlap()
    {
        ...
        Assert.assertEquals("Year match", "v5", entries.get(Intervals.of("2025-01-01T00:00:00/P1Y")));
    }
    ...
    public void testRemove() {
        ...
        Assert.assertEquals("Size", 3, tree.size());
    }
    ...
    {
        IntervalTree<String> tree = setupBaseIntervalTree();
        tree.add(Intervals.of("2025-01-01T00:00:00/P1Y"), "v5");
