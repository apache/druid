...
public class ImmutableRTreeTest
{
  ...
  public void testToAndFromByteBuffer()
  {
    ...
    Assertions.assertTrue(finalSet.size() >= 5);
    Set<Integer> expected = Sets.newHashSet(1, 2, 3, 4, 5);
    IntIterator iter = finalSet.iterator();
    while (iter.hasNext()) {
      Assertions.assertTrue(expected.contains(iter.next()));
    }
  }
  ...
  public void testSearchNoSplit()
  {
    ...
    Assertions.assertEquals(tree.getRoot().getChildren().size(), 10);
  ...
  public void testSearchWithSplit3()
  {
    ...
    ImmutableBitmap finalSet = bf.union(points);
    Assertions.assertTrue(finalSet.size() >= 3);
  ...
  public void testSearchWithSplit4()
  {
    ...
    ImmutableBitmap finalSet = bf.union(points);
    Assertions.assertTrue(finalSet.size() == 500);
  ...
  public void testEmptyConciseSet()
  {
    ...
    ImmutableBitmap finalSet = bf.union(points);
    Assertions.assertEquals(finalSet.size(), 0);
  }
  ...
  public void testEmptyRoaringBitmap()
  {
    ...
    ImmutableBitmap finalSet = bf.union(points);
    Assertions.assertEquals(finalSet.size(), 0);
    Assertions.assertTrue(finalSet.isEmpty());
  }
  ...
  public void testToBytes()
  {
    ...
    org.junit.jupiter.api.Assertions.assertEquals(Bytes.asList(bytes1), Bytes.asList(bytes2));
  }
  ...
  public void testPreciseRadiusBoundFilter()
  {
    ...
    org.junit.jupiter.api.Assertions.assertTrue(((FluentIterable) points).toList().size() == 100);
    ImmutableBitmap finalSet = bf.union(points);
    Assertions.assertTrue(finalSet.size() == 100);
  }
