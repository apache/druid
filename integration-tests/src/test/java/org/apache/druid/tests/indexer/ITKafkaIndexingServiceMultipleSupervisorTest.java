...
public class ITKafkaIndexingServiceMultipleSupervisorTest extends AbstractKafkaIndexingServiceTest
{
  @Override
  ...
  /**
   * This test tests multiple (2) supervisors simultaneously ingesting into the same datasource
   */
  @Test
