...
|`org.apache.druid.java.util.metrics.CgroupV2CpuMonitor`|Reports CPU usage from `cpu.stat` file in cgroups.|
|`org.apache.druid.java.util.metrics.CgroupV2DiskMonitor`|Reports disk usage from `io.stat` file in cgroups.|
|`org.apache.druid.java.util.metrics.CgroupV2MemoryMonitor`|Reports memory usage from `memory.current` and `memory.max` files in cgroups.|
