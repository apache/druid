...
| `druid.cache.hosts`           | Comma separated list of Memcached hosts `<host:port>`. Needed only when druid.cache.clientMode=static. Dynamic mode [automatically identifies nodes in your cluster](https://docs.aws.amazon.com/AmazonElastiCache/latest/mem-ug/AutoDiscovery.html)                                                                                                                                                                                                                            | none              |
...
| `druid.cache.enableTls`       | Use TLS based ssl connection for Memcached client.  Boolean                                                                                                                                                                                                                                                                                                                                                                                                                     | false             |
