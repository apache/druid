...
|`druid.server.http.returnJettyErrorsInJson`|When set to true, any error from the Jetty layer / Jetty filter is returned as a JSON response. If set to false, the error response is returned as HTML.|false|
