...
|`druid.server.http.uriCompliance`|Jetty UriCompliance mode for Druid's embedded Jetty servers. To modify, override this config with the string representation of any URiComplicance mode that Jetty supports.|LEGACY|
