...
|`druid.coordinator.kill.maxSegments`|The number of unused segments to kill per kill task submission. This number must be greater than 0. This only applies when `druid.coordinator.kill.on=true`.|100|
