...
|`org.apache.druid.server.metrics.SupervisorStatsMonitor`|Reports supervisor count and state (RUNNING, SUSPENDED, UNHEALTHY_SUPERVISOR, UNHEALTHY_TASKS, etc.) per supervisor.|Overlord|
