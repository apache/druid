...
|`druid.metadata.storage.tables.truncateIndexIdentifiers`|Whether to truncate index identifiers in the case of long base table names. If generated index identifier is too long for the underlying engine, the index won't be created.|false|
