...
|`druid.coordinator.guildReplication.on`| Boolean flag for whether or not the Coordinator should attempt to load and balance segments in a way that prioritizes segments being loaded onto two or more guilds.|false|
