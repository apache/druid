...
|`druid.sql.planner.forceExpressionVirtualColumns`|If true, the query plan does not contain any specialized virtual columns. Instead, specialized virtual columns (such as "mv-filered") are planned as "expression"-type virtual columns. If false, such virtual columns are planned in their respective specialized forms.|false|
