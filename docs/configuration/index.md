...
If you enable this feature, you can query datasources that are only stored in cold storage and are not loaded on a Historical. For more information, see [Query from deep storage](../querying/query-from-deep-storage.md).
