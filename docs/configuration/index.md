...
| `org.apache.druid.indexing.common.stats.OverlordStatusMonitor` | Reports overlord leader count. Only supported by overlord node types.                                                                                                                                                                       |
| `org.apache.druid.server.metrics.CoordinatorStatusMonitor`     | Reports coordinator leader count. Only supported by coordinator node types.                                                                                                                                                                    |
