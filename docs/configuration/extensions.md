...
| druid-pac4j-v5                   | OpenID Connect authentication for druid processes. Uses v5+ for pac4j. Incompatible with JDK8.                                                                                                                             | [link](../development/extensions-core/druid-pac4j-v5.md)           |
