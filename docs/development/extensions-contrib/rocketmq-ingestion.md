...
Now this propertiy on support one property. This must contain a property `nameserver.url` with a list of RocketMQ name servers in the form: `<NAMESREV_1>:<PORT_1>;<NAMESREV_2>:<PORT_2>;...`.
