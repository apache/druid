...
|`druid.indexer.task.enableTaskPayloadManagerPerTask	`| `boolean`       | Whether druid.indexer.logs.type should be used to pass task payloads to the K8s jobs. Set this to true if you plan on using task payloads > 1 MB                                                                                                 | `false`                           |No|
