...
Use a native batch [Parallel task](../../ingestion/native-batch.md) with an [S3 input source](../../ingestion/input-sources.html#s3-input-source) to read objects directly from S3.
...
Alternatively, you can bypass this chain by specifying an access key and secret key using a [Properties Object](../../ingestion/input-sources.html#s3-input-source) inside your ingestion specification.
