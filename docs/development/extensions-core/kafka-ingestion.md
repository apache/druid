...
|`autoscalerConfigDefault`|Object|`autoscalerConfigDefault` to specify how to auto scale the number of Kafka ingest tasks based on Lag metrics. ONLY supported for Kafka indexing as of now. See [Tasks Autoscaler Properties](#Tasks Autoscaler Properties) for details.|no (default == null)|

#### Tasks Autoscaler Properties

| Property | Description | Default |
| ------------- | ------------- | ------------- |
| `enableTaskAutoscaler` | whether enable this feature or not. Set false here will disable `autoscaler` even though `autoscalerConfigDefault` is not null| true |
