...
|`skipIgnorableShards`|Boolean|The Supervisor skips closed and empty shards as these need not be processed for ingestion. May help during resharding of stream.|no (default == false)|
