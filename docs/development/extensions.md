...
|prometheus-emitter|This extension exposes [Druid metrics](https://druid.apache.org/docs/latest/operations/metrics.html) for collection by a Prometheus server (https://prometheus.io/)|[link](../development/extensions-contrib/prometheus-emitter.md)|
