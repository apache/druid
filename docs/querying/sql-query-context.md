...
|`msqDenySelect`| If false (default behavior), both MSQ SELECT and INSERT queries will be planned. If true, MSQ SELECT queries will be rejected.<br /><br | default: false|
