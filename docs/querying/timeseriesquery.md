...
|virtualColumns|Define any [virtual columns](./virtual-columns.md) to be available to referenced as inputs to `aggregations` or `postAggregations`.| no (default none)|
