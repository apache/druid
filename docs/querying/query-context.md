...
|`priority`         | The default priority is one of the following: <ul><li>The value of `druid.query.default.context.priority`, if set and not null</li><li>Value of the query context configuration, if set</li><li>`0` if the priority is not set in the runtime properties or the query context</li></ul>| Query priority. Queries with higher priority get precedence for computational resources.|
