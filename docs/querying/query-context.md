...
|`includeTrailerHeader`|`false`|Whether the response can include trailer headers, which are currently used to indicate any error messages in the case of a chunked response, if any.|
