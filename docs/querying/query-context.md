...
|brokerServiceName| `null`                                 | Broker service to which this query should be routed. This parameter is honored only by a broker selector strategy of type *queryContext*. See [Router strategies](../design/router.md#router-strategies) for more details.|
