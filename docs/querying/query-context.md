...
|`maxInputBytesPerWorker`|`10737418240`| Maximum number of input bytes per worker, used when assigning input slices to tasks. Used only in case number of tasks is determined automatically. |
