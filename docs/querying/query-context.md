...
|maxNumericInFilters|`10000`|If set to a value between 1 and 10,000, Druid will allow numeric values specified for IN part of the query not to exceed this user defined value. Queries with more than 10000 numeric IN filters wont be executed. Users are advised to cast their values to String if they have more than 10000 IN filters in their query. For example, instead of IN(1,2,3,...) specify as IN('1','2','3',...)|
