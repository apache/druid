...
|`priority`         | The default priority is one of the following: <ul><li>Value of the query context configuration, if set</li><li>The value of `druid.query.default.context.priority`, if set and not null</li><li>`0` if the priority is not set in the query context or runtime properties</li></ul>| Query priority. Queries with higher priority get precedence for computational resources.|
