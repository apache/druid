...
The `server_properties` table exposes configuration properties for each Druid server. Each row represents a single property key-value pair associated with a specific server.
