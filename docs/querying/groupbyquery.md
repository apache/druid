...
> In release 0.17.0 and earlier, such dimensions were entirely excluded from the result. If you were relying on this old behaviour to determine whether a particular dimension was not part of
