...
|virtualColumns|Define any [virtual columns](./virtual-columns.md) to be available to use as the grouping `dimension` or referenced as inputs to `aggregations` or `postAggregations`.| no (default none)|
