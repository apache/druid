...
|`useGroupingSetForExactDistinct`|Whether to use grouping sets to execute queries with multiple exact distincts.|druid.sql.planner.useGroupingSetForExactDistinct on the Broker (default: false)|
