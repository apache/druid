...
> Replace `<queryable_host>:<port>` with the appropriate address and port for your system. If running Druid in the quickstart configuration, replace `<queryable_host>:<port>` with localhost:8082. 
