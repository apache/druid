...
|--------|-----------|---------|
|queryType|This String should always be "dataSourceMetadata"; this is the first thing Apache&circledR; Druid looks at to figure out how to interpret the query|yes|
