...
* Fixes an issue with topN queries using query granularity other than 'ALL' which could cause some query correctness issues [#17565](https://github.com/apache/druid/pull/17565)
