...
Front-coded dictionaries can reduce storage and improve performance by optimizing values with a shared common prefix to not have to be duplicately stored.
