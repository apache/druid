...
|`druid.sql.planner.forceTimeCondition`|Whether to force SQL to have filter conditions on __time field so that all generated native queries will have user specified intervals. If true, all queries wihout __time condition will fail|false|
