...
|`druid.coordinator.merge.on`|Deprecated. MergeTasks created by enabling this option wouldn't work with newly generated segments. Use [compaction](../operations/api-reference.html#compaction-configuration) instead. Boolean flag for whether or not the Coordinator should try and merge small segments into a more optimal segment size.|false|
