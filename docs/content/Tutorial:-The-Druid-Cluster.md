...
You can download the latest version of druid [here](http://static.druid.io/artifacts/releases/druid-services-0.6.91-bin.tar.gz)
...
druid.extensions.coordinates=["io.druid.extensions:druid-s3-extensions:0.6.91"]
...
druid.extensions.coordinates=["io.druid.extensions:druid-examples:0.6.91","io.druid.extensions:druid-kafka-seven:0.6.91"]
