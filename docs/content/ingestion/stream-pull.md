...
|indexSpec|Object|Tune how data is indexed.|no|
...
|Field|Type|Description|Required|
|-----|----|-----------|--------|
|bitmap|String|Set to `roaring` to use Roaring Bitmaps. Set to `concise` to use Concise bitmaps.|no (default = concise)|
