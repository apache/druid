...
* Dimensions are fields that can be filtered on or grouped by. Dimensions can have Long, Float, or String types. Each String dimension within a row can hold a single value or an array of values. Long and Float dimensions can only hold single values.
