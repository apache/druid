...
The home view provide a high level overview of the cluster. Each card is clickable and links to the appropriate view. The legacy menu allows you to go to the [older coordinator and overlord console](./management-uis#legacy-consoles) should you need them.
