...
The input source defines where your index task reads data for Apache&circledR; Druid native batch ingestion. Only the native parallel task and simple task support the input source.
