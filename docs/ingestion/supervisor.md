...
|`highLagThreshold`|Per-partition lag threshold that triggers burst scale-up when set to `0` or higher. Set to a negative value to disable burst scale-up.|No|-1|
