...
|`lookupsToLoad`|Comma separated list of lookup names that will be loaded in tasks. This property is required only if the `lookupLoadingMode` is set to `ONLY_REQUIRED`. |`null`|
