...
|`coordinator/global/time`|Approximate runtime of a full coordination cycle in milliseconds. The `dutyGroup` dimension indicates what type of coordination this run was, that is Historical Management or Indexing.|`dutyGroup`|Varies|
