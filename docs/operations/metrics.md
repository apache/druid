...
|`metadatacache/backfill/count`|Number of segment for which schema was backfilled in the database.|`dataSource`|
...
|`schemacache/inTransitSMQPublishedResults/size`|Number of segment for which schema was backfilled in the database.||Eventually it should be 0.|
