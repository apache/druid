...
|`task/segmentAvailability/wait/time`|The amount of milliseconds a task waited for newly created segments to become available for querying.|dataSource, taskType, taskId, segmentAvailabilityConfirmed|Varies.|
