...
* Do not provide plain-text passwords for production systems in configuration specs. For example, sensitive properties in the consumerProperties of `KafkaSupervisorIngestionSpec`.
