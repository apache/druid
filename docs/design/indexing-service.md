...
Indexing [tasks](../api-reference/tasks.md) create (and sometimes destroy) Druid [segments](../design/segments.md). The indexing service has a master/slave like architecture.
...
See [Tasks](../api-reference/tasks.md).
