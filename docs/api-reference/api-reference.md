...
> Caution : Avoid using indexing or kill tasks and these APIs at the same time for the same datasource and time chunk. It's fine if the time chunks or datasource don't overlap.
