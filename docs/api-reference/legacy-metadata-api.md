...
This document describes the legacy API endpoints to retrieve datasource metadata from Apache&circledR; Druid. Use the [SQL metadata tables](../querying/sql-metadata-tables.md) to retrieve datasource metadata instead.
