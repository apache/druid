...
See [SQL JSON documentation](../querying/sql-json-functions.md#jsonpath-syntax) for examples and [Nested columns](./nested-columns.md) for more information on ingesting and storing nested data.
