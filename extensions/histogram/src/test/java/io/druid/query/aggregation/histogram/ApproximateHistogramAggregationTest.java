...
public class ApproximateHistogramAggregationTest
{
  ...
  public void testIngestAndQuery() throws Exception
  {
    ...
    AggregationTestHelper helper = new AggregationTestHelper(Lists.newArrayList(module.getJacksonModules()));
    ...
    Assert.assertEquals(59.021023, row.getFloatMetric("index_min"), 0.0001);
    Assert.assertEquals(1870.061, row.getFloatMetric("index_max"), 0.0001);
    Assert.assertEquals(1614.6807, row.getFloatMetric("index_quantile"), 0.0001);
  }
}
