...
public class MsSQLMetadataStorageModule extends SQLMetadataStorageDruidModule implements DruidModule
{

  public static final String TYPE = "mssql";

  public MsSQLMetadataStorageModule()
  {
    super(TYPE);
  }
