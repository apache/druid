...
public class EvalTest
{
  ...
  public void testLongEval()
  {
    ...
    Assert.assertEquals("NULL", eval("nvl(if(x == 9223372036854775807, '', 'x'), 'NULL')", bindings).stringValue());
    Assert.assertEquals("x", eval("nvl(if(x == 9223372036854775806, '', 'x'), 'NULL')", bindings).stringValue());
  }
}
