...
@JsonSubTypes(value = {
    ...
    @JsonSubTypes.Type(name = "parallelIndexSinglePhase", value = ParallelIndexSinglePhaseSupervisorTask.class),
    @JsonSubTypes.Type(name = "subIndexSinglePhase", value = ParallelIndexSinglePhaseSubTask.class),
