...
@JsonSubTypes(value = {
    ...
    @JsonSubTypes.Type(name = "index_single_phase_parallel", value = SinglePhaseParallelIndexSupervisorTask.class),
    @JsonSubTypes.Type(name = "index_single_phase_sub", value = SinglePhaseParallelIndexSubTask.class),
