...
public class CostBasedAutoScalerConfig implements AutoScalerConfig
{
  ...
  private final double idealIdleRatio;
  ...
  )
  {
    ...
    this.idealIdleRatio = Configs.valueOrDefault(idealIdleRatio, WeightedCostFunction.IDEAL_IDLE_RATIO);
    ...
    Preconditions.checkArgument(
        this.idealIdleRatio > 0.0 && this.idealIdleRatio < 1.0,
        "idealIdleRatio must be > 0 and < 1"
    );
    Preconditions.checkArgument(
   ...
   */
  @JsonProperty
  public double getIdealIdleRatio()
  {
    return idealIdleRatio;
  }
  ...
  public boolean equals(Object o)
  {
    ...
    return enableTaskAutoScaler == that.enableTaskAutoScaler
           ...
           && Double.compare(that.idealIdleRatio, idealIdleRatio) == 0
  ...
  public static class Builder
  {
    ...
    public Builder idealIdleRatio(double idealIdleRatio)
    {
      this.idealIdleRatio = idealIdleRatio;
      return this;
    }
