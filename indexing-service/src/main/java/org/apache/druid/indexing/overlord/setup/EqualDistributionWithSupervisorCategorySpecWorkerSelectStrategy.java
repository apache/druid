...
public class EqualDistributionWithSupervisorCategorySpecWorkerSelectStrategy implements WorkerSelectStrategy
{
  private final WorkerCategorySpec workerCategorySpec;
  private final TaskLimits taskLimits;

  @JsonCreator
  public EqualDistributionWithSupervisorCategorySpecWorkerSelectStrategy(
  ...
  {
    return WorkerSelectUtils.selectWorkerBySupervisorCategorySpec(
        task,
        zkWorkers,
        config,
        workerCategorySpec,
  ...
  public boolean equals(final Object o)
  {
    ...
    final EqualDistributionWithSupervisorCategorySpecWorkerSelectStrategy that = (EqualDistributionWithSupervisorCategorySpecWorkerSelectStrategy) o;
  ...
  {
    return "EqualDistributionWithSupervisorCategorySpecWorkerSelectStrategy{" +
