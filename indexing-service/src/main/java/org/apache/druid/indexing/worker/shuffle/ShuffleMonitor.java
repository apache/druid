  ...
  public boolean doMonitor(ServiceEmitter emitter)
  {
    if (shuffleMetrics != null) {
      ...
      snapshot.forEach((supervisorTaskId, perDatasourceShuffleMetrics) -> {
        ...
        emitter.emit(metricBuilder.setMetricAndValue(SHUFFLE_BYTES_KEY, perDatasourceShuffleMetrics.getShuffleBytes()));
        emitter.emit(metricBuilder.setMetricAndValue(SHUFFLE_REQUESTS_KEY, perDatasourceShuffleMetrics.getShuffleRequests()));
      });
    }
    return true;
  }
