...
import org.apache.druid.server.http.security.ServerPermissionsResourceFilter;
...
public class SamplerResource
{
  ...
  @ResourceFilters({ StateResourceFilter.class, ServerPermissionsResourceFilter.class })
