...
@JsonSubTypes(value = {
    ...
    @JsonSubTypes.Type(name = PartialHashSegmentGenerateTask.TYPE, value = PartialHashSegmentGenerateTask.class),
    @JsonSubTypes.Type(name = PartialHashSegmentMergeTask.TYPE, value = PartialHashSegmentMergeTask.class),
