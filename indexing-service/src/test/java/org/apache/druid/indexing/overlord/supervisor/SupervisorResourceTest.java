...
public class SupervisorResourceTest extends EasyMockSupport
{
  ...
  @Test
  public void testGetReindexingTimeline_success()
  {
    CompactionSupervisorSpec compactionSpec = EasyMock.createMock(CompactionSupervisorSpec.class);
    CascadingReindexingTemplate template = EasyMock.createMock(CascadingReindexingTemplate.class);
    ReindexingTimelineView timelineView = EasyMock.createMock(ReindexingTimelineView.class);

    EasyMock.expect(taskMaster.getSupervisorManager()).andReturn(Optional.of(supervisorManager));
    EasyMock.expect(supervisorManager.getSupervisorSpec("compaction-id")).andReturn(Optional.of(compactionSpec));
    ...
    EasyMock.replay(compactionSpec, template, timelineView);
    replayAll();

    Response response = supervisorResource.getReindexingTimeline("compaction-id", null);

    Assert.assertEquals(200, response.getStatus());
    Assert.assertEquals(timelineView, response.getEntity());
    verifyAll();
    EasyMock.verify(compactionSpec, template, timelineView);
  }

  @Test
  public void testGetReindexingTimeline_supervisorNotFound()
  {
    EasyMock.expect(taskMaster.getSupervisorManager()).andReturn(Optional.of(supervisorManager));
    EasyMock.expect(supervisorManager.getSupervisorSpec("missing-id")).andReturn(Optional.absent());
    replayAll();

    Response response = supervisorResource.getReindexingTimeline("missing-id", null);
  ...
  @Test
  public void testGetReindexingTimeline_notCompactionSupervisor()
  {
    TestSupervisorSpec regularSpec = new TestSupervisorSpec("regular-id", null, null);

    EasyMock.expect(taskMaster.getSupervisorManager()).andReturn(Optional.of(supervisorManager));
    EasyMock.expect(supervisorManager.getSupervisorSpec("regular-id")).andReturn(Optional.of(regularSpec));
    replayAll();

    Response response = supervisorResource.getReindexingTimeline("regular-id", null);
  ...
  @Test
  public void testGetReindexingTimeline_notCascadingReindexingTemplate()
  {
    CompactionSupervisorSpec compactionSpec = EasyMock.createMock(CompactionSupervisorSpec.class);
    CompactionJobTemplate template = EasyMock.createMock(CompactionJobTemplate.class);

    EasyMock.expect(taskMaster.getSupervisorManager()).andReturn(Optional.of(supervisorManager));
    EasyMock.expect(supervisorManager.getSupervisorSpec("compaction-id")).andReturn(Optional.of(compactionSpec));
    EasyMock.expect(compactionSpec.getTemplate()).andReturn(template);
    EasyMock.replay(compactionSpec, template);
    replayAll();
  ...
  @Test
  public void testGetReindexingTimeline_withReferenceTime()
  {
    CompactionSupervisorSpec compactionSpec = EasyMock.createMock(CompactionSupervisorSpec.class);
    CascadingReindexingTemplate template = EasyMock.createMock(CascadingReindexingTemplate.class);
    ReindexingTimelineView timelineView = EasyMock.createMock(ReindexingTimelineView.class);
    ...
    Response response = supervisorResource.getReindexingTimeline("compaction-id", "2024-01-01T00:00:00.000Z");
  ...
  @Test
  public void testGetReindexingTimeline_invalidReferenceTimeFormat()
  {
    CompactionSupervisorSpec compactionSpec = EasyMock.createMock(CompactionSupervisorSpec.class);

    EasyMock.expect(taskMaster.getSupervisorManager()).andReturn(Optional.of(supervisorManager));
    EasyMock.expect(supervisorManager.getSupervisorSpec("compaction-id")).andReturn(Optional.of(compactionSpec));
    EasyMock.replay(compactionSpec);
    replayAll();

    Response response = supervisorResource.getReindexingTimeline("compaction-id", "not-a-date");
  ...
  @Test
  public void testGetReindexingTimeline_serviceUnavailable()
  {
    EasyMock.expect(taskMaster.getSupervisorManager()).andReturn(Optional.absent());
    replayAll();

    Response response = supervisorResource.getReindexingTimeline("any-id", null);
