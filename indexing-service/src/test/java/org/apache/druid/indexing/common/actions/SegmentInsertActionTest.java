...
public class SegmentInsertActionTest
{
  ...
  public void testSimple() throws Exception
  {
    ...
    final SegmentInsertAction action = new SegmentInsertAction(ImmutableSet.of(SEGMENT1, SEGMENT2), Collections.emptyMap());
  ...
  {
    final Task task = NoopTask.create();
    final SegmentInsertAction action = new SegmentInsertAction(ImmutableSet.of(SEGMENT3), Collections.emptyMap());
    actionTestKit.getTaskLockbox().add(task);
    acquireTimeChunkLock(TaskLockType.EXCLUSIVE, task, INTERVAL, 5000);
