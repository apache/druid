...
public class TaskActionPreconditionsTest
{
  ...
  @Test
  public void testCheckLockCoversIntervals()
  {
    final List<Interval> intervals = ImmutableList.of(
        Intervals.of("2017-01-01/2017-01-02"),
        Intervals.of("2017-01-02/2017-01-03"),
    ...
    Assert.assertEquals(3, locks.size());
    Assert.assertTrue(TaskActionPreconditions.isLockCoversIntervals(task, lockbox, task.getDataSource(), intervals));
  }

  @Test
  public void testCheckSingleLargeLockCoversIntervals()
  {
    final List<Interval> intervals = ImmutableList.of(
        Intervals.of("2017-01-01/2017-01-10")
    );
  ...
  @Test
  public void testCheckLockCoversIntervalsWithOverlappedIntervals()
  {
    final List<Interval> intervals = ImmutableList.of(
        Intervals.of("2016-12-31/2017-01-01"),
        Intervals.of("2017-01-01/2017-01-02"),
    ...
    Assert.assertEquals(3, locks.size());
    Assert.assertFalse(
        TaskActionPreconditions.isLockCoversIntervals(
            task,
            lockbox,
            task.getDataSource(),
