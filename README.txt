...
Documentation
-----------------
You can find the documentation for the latest Druid release on the project website http://druid.io/docs/latest/.

You can get started with Druid with our quickstart at http://druid.io/docs/latest/tutorials/quickstart.html.
...
Prerequisites:
  JDK 8, minimum 8u92, recommended 8u191+ if using Docker
  Maven version 3.x
