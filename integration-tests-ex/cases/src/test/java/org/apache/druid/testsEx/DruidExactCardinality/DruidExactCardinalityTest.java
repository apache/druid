...
public class DruidExactCardinalityTest extends AbstractIndexerTest
{
  ...
  private final String fullDatasourceName = DATASOURCE + config.getExtraDatasourceNameSuffix();
