...
public class ITMultiStageQuery
{
  ...
  @Test
  public void testMsqIngestionWithoutSequentialMerging() throws Exception
  {
    String datasource = "dst";
    ...
    // Submit the task and wait for the datasource to get loaded
    SqlQuery sqlQuery = new SqlQuery(queryLocal, null, false, false, false, ImmutableMap.of("msqForceNonSequentialMerging", true), null);
