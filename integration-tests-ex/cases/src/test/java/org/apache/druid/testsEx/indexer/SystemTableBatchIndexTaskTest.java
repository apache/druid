...
public class SystemTableBatchIndexTaskTest extends AbstractITBatchIndexTest
{
  private static final Logger LOG = new Logger(SystemTableBatchIndexTaskTest.class);
