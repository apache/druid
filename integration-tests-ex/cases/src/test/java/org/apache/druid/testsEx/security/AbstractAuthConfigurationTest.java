...
import org.apache.druid.testsEx.security.AbstractAuthConfigurationTest.User;
...
public abstract class AbstractAuthConfigurationTest
{
  ...
  // NOTE: The results have been edited for a non-SSL system. Replace the tls_port
  // fields when this test runs under TLS.
  ...
  protected static List<Map<String, Object>> adminSegments;
  protected static List<Map<String, Object>> adminTasks;
  protected static List<Map<String, Object>> adminServers;
  protected static List<Map<String, Object>> adminServerSegments;

  protected static Map<User, HttpClient> httpClients;
