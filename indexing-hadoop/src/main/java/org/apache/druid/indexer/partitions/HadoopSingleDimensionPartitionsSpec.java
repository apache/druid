...
public class HadoopSingleDimensionPartitionsSpec extends SingleDimensionPartitionsSpec implements HadoopPartitionsSpec
{
  public HadoopSingleDimensionPartitionsSpec(
  ...
  {
    super(targetPartitionSize, maxPartitionSize, partitionDimension, assumeGrouped);
  }
  ...
  {
    return "HadoopSingleDimensionPartitionsSpec{} " + super.toString();
  }
}
