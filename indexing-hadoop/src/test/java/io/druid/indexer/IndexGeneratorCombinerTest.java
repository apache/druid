...
public class IndexGeneratorCombinerTest
{
  ...
  public void testMultipleRowsMerged() throws Exception
  {
    ...
    Assert.assertEquals(15, capturedRow.getMetric("visited_sum"));
    Assert.assertEquals(
        2.0,
  ...
  public void testMultipleRowsNotMerged() throws Exception
  {
    ...
    Assert.assertEquals(10, capturedRow1.getMetric("visited_sum"));
    Assert.assertEquals(
        1.0,
    ...
    Assert.assertEquals(5, capturedRow2.getMetric("visited_sum"));
    Assert.assertEquals(
        1.0,
